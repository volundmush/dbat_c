...
extern bool check_skill(struct char_data *ch, int skill);
...
extern bool can_kill(struct char_data *ch, struct char_data *vict, struct obj_data *obj, int num);
...
extern bool limb_ok(struct char_data *ch, int type);
...
extern long double calc_critical(struct char_data *ch, int loc);
...
extern bool backstab(struct char_data *ch, struct char_data *vict, int wlvl, int64_t dmg);
...
extern bool boom_headshot(struct char_data *ch);
...
extern bool check_ruby(struct char_data *ch);
