...
#define SLASH "/"
#define LIB_USER "user" SLASH
#define LIB_INTRO "intro" SLASH
#define LIB_SENSE "sense" SLASH
#define LIB_WORLD "world" SLASH
#define LIB_TEXT "text" SLASH
#define LIB_TEXT_HELP "text" SLASH "help" SLASH
#define LIB_MISC "misc" SLASH
#define LIB_ETC "etc" SLASH
#define LIB_PLRTEXT "plrtext" SLASH
#define LIB_PLROBJS "plrobjs" SLASH
#define LIB_PLRVARS "plrvars" SLASH
#define LIB_PLRALIAS "plralias" SLASH
#define LIB_PLRFILES "plrfiles" SLASH
#define LIB_HOUSE "house" SLASH
#define LIB_PLRIMC "plrimc" SLASH
