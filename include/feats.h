...
extern bool is_proficient_with_armor(const struct char_data *ch, int armor_type);

extern bool is_proficient_with_weapon(const struct char_data *ch, int weapon_type);
...
extern bool feat_is_available(struct char_data *ch, int featnum, int iarg, char *sarg);
