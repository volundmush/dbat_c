...
extern struct obj_data *unequip_char(struct char_data *ch, int pos);

extern bool invalid_align(struct char_data *ch, struct obj_data *obj);
...
extern struct char_data *get_char_room(char *name, int *num, room_rnum room);

extern struct char_data *get_char_num(mob_rnum nr);
...
extern struct obj_data *get_obj_num(obj_rnum nr);

extern struct obj_data *get_obj_in_list_vis(struct char_data *ch, char *name, int *number, struct obj_data *list);

extern struct obj_data *get_obj_vis(struct char_data *ch, char *name, int *num);

extern struct obj_data *
get_obj_in_equip_vis(struct char_data *ch, char *arg, int *number, struct obj_data *equipment[]);
