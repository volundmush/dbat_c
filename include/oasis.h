...
extern void sedit_setup_existing(struct descriptor_data *d, int rshop_num);
...
extern bool parse_stats(struct descriptor_data *d, char *arg);

extern int stats_disp_menu(struct descriptor_data *d);

extern bool free_strings(void *data, int type);
...
extern bool can_edit_zone(struct char_data *ch, zone_rnum rnum);
...
extern bool context_help(struct descriptor_data *d, char *arg);
