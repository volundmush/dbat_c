...
#define ASPELL(spellname)                                                                                              \
    void spellname(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj, const char *arg)
...
int cast_spell(struct char_data *ch, struct char_data *tch, struct obj_data *tobj, int spellnum, char *arg);
