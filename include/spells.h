...
extern bool call_magic(struct char_data *caster, struct char_data *cvict,
...
extern bool mag_newsaves(struct char_data *ch, struct char_data *victim, int spellnum,
