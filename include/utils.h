...
extern bool masadv(char *tmp, struct char_data *ch);
...
extern bool mob_respond(struct char_data *ch, struct char_data *vict, const char *speech);

extern int armor_evolve(struct char_data *ch);

extern bool has_group(struct char_data *ch);
...
extern bool roll_pursue(struct char_data *ch, struct char_data *vict);
...
extern bool get_filename(char *filename, size_t fbufsize, int mode, const char *orig_name);
...
extern bool block_calc(struct char_data *ch);
