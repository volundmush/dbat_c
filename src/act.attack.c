    ...
    for (vict = world[IN_ROOM(ch)].people; vict; vict = next_v) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            act("@C$N@c disappears, avoiding the explosion before reappearing elsewhere!@n", 0, ch, 0, vict,
                TO_CHAR);
            act("@cYou disappear, avoiding the explosion before reappearing elsewhere!@n", 0, ch, 0, vict, TO_VICT);
            act("@C$N@c disappears, avoiding the explosion before reappearing elsewhere!@n", 0, ch, 0, vict,
                TO_NOTVICT);
            ...
            act("@c$N@W manages to dodge the light grenade!@n", 1, ch, 0, vict, TO_CHAR);
            act("@WYou manages to dodge the light grenade!@n", 1, ch, 0, vict, TO_VICT);
            act("@c$N@W manages to dodge the light grenade!@n", 1, ch, 0, vict, TO_NOTVICT);
            ...
            act("@R$N@r is hit by the light grenade which explodes all around $m!@n", 1, ch, 0, vict, TO_CHAR);
            act("@RYou are hit by the light grenade which explodes all around you!@n", 1, ch, 0, vict, TO_VICT);
            act("@R$N@r is hit by the light grenade which explodes all around $m!@n", 1, ch, 0, vict, TO_NOTVICT);
            ...
            act("@R$N@r is caught by the light grenade's explosion!@n", 1, ch, 0, vict, TO_CHAR);
            act("@RYou are caught by the light grenade's explosion!@n", 1, ch, 0, vict, TO_VICT);
            act("@R$N@r is caught by the light grenade's explosion!@n", 1, ch, 0, vict, TO_NOTVICT);
            if (!AFF_FLAGGED(vict, AFF_FLYING) && GET_POS(vict) == POS_STANDING && rand_number(1, 4) == 4) {
                handle_knockdown(vict);
            }
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@cYou disappear, avoiding @C$n's@c breath before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c breath before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@WYou move quickly and block @C$n's@W fiery breath!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W fiery breath!@n", 1, ch, 0, vict, TO_NOTVICT);
                    ...
                    act("@WYou dodge the fiery jets of flames coming from @C$n's@W mouth!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge the fiery jets of flames coming from @c$n's@W mouth!@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    ...
                    act("@C$n@W moves to breath flames on you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W moves to breath flames on @C$N@W, but somehow misses!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@C$n@W moves to breath flames on you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n@W moves to breath flames on @C$N@W, but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                pcost(ch, 0, stcost / 2);
        ...
        act("@C$n@W breathes flames on $p@W!@n", 1, ch, obj, 0, TO_ROOM);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@cYou disappear, avoiding @C$n's@c ram before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c ram before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@WYou move quickly and block @C$n's@W body as $e tries to ram YOU!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W body as $e tries to ram $M!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@WYou dodge @C$n's@W attempted ram!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W attempted ram!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@C$n@W moves to ram you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W moves to ram @C$N@W, but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@C$n@W aims $s body at YOU and rams into YOUR body!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W aims $s body at @C$N@W and rams into $S body!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@C$n@W aims $s body at YOU and rams into YOUR face!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W aims $s body at @C$N@W and rams into $S face!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 4);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 3:
                    ...
                    break;
                case 4: /* Weak */
                    act("@C$n@W aims $s body at YOU and rams into YOUR arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W aims $s body at @C$N@W and rams into $S arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@C$n@W aims $s body at YOU and rams into YOUR leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W aims $s body at @C$N@W and rams into $S leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@C$n@W rams $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@cYou disappear, avoiding @C$n's@c fang strike before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c fang strike before reappearing!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@WYou parry @C$n's@W fang strike with a punch of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W fang strike with a punch of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    ...
                    act("@WYou move quickly and block @C$n's@W fang strike!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W fang strike!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 6, skill, attperc);
                    ...
                    act("@WYou dodge @C$n's@W fang strike!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W fang strike!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@C$n@W moves to fang strike you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W moves to fang strike @C$N@W, but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@C$n@W launches $s body at YOU and sinks $s fang strike into YOUR body!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@c$n@W launches $s body at @C$N@W and sinks $s fang strike into $S body!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 2: /* Critical */
                    act("@C$n@W launches $s body at YOU and sinks $s fang strike into YOUR face!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@c$n@W launches $s body at @C$N@W and sinks $s fang strike into $S face!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 4);
                ...
                case 3:
                    ...
                    break;
                case 4: /* Weak */
                    act("@C$n@W launches $s body at YOU and sinks $s fang strike into YOUR arm!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@c$n@W launches $s body at @C$N@W and sinks $s fang strike into $S arm!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@C$n@W launches $s body at YOU and sinks $s fang strike into YOUR leg!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@c$n@W launches $s body at @C$N@W and sinks $s fang strike into $S leg!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@C$n@W fang strikes $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Sundering Force before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Sundering Force before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Sundering Force before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                ...
                act("@C$N@c disappears, trying to avoid your Sundering Force but your zanzoken is faster!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@cYou zanzoken to avoid the Sundering Force but @C$n's@c zanzoken is faster!@n", 0, ch, 0,
                    vict, TO_VICT);
                act("@C$N@c disappears, trying to avoid @C$n's@c Sundering Force but @C$n's@c zanzoken is faster!@n",
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Sundering Force, letting it fly harmlessly by!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Sundering Force, letting it fly harmlessly by!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Sundering Force, letting it fly harmlessly by!@n", 0, ch,
                        0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                    ...
                    act("@WYou can't believe it but your Sundering Force misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Sundering Force at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Sundering Force at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                ...
                act("@WYou can't believe it but your Sundering Force misses, flying through the air harmlessly!@n",
                    0, ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Sundering Force at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Sundering Force at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
            }
            hurt(0, 0, ch, vict, NULL, 0, 1);
            return;
        ...
        dmg /= 10;
        act("@WYou fire a Sundering Force at $p@W!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a Sundering Force at $p@W!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Zen Blade Strike before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Zen Blade Strike before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Zen Blade Strike before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > rand_number(1, 130)) {
                    act("@C$N@W moves quickly and blocks your Zen Blade Strike!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Zen Blade Strike!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Zen Blade Strike!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_ZEN) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your Zen Blade Strike, letting it slam into the surroundings!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Zen Blade Strike, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your Zen Blade Strike misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Zen Blade Strike at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Zen Blade Strike at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your Zen Blade Strike misses, flying through the air harmlessly!@n",
                    0, ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Zen Blade Strike at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Zen Blade Strike at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_ZEN) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
        ...
        dmg /= 10;
        act("@WYou fire a Zen Blade Strike at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a Zen Blade Strike at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Malice Breaker before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Malice Breaker before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Malice Breaker before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > rand_number(1, 130)) {
                    act("@C$N@W moves quickly and blocks your Malice Breaker!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Malice Breaker!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Malice Breaker!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your Malice Breaker, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Malice Breaker, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your Malice Breaker misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Malice Breaker at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Malice Breaker at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your Malice Breaker misses, flying through the air harmlessly!@n",
                    0, ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Malice Breaker at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Malice Breaker at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 36, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Malice Breaker at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a Malice Breaker at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your headbutt before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c headbutt before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c headbutt before reappearing!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your headbutt with an attack of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W headbutt with an attack of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W headbutt with an attack of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W blocks your headbutt!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou block @C$n's@W headbutt!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W headbutt!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W dodges your headbutt!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W headbutt!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W headbutt!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your headbutt misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W throws a headbutt at you, but thankfully misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W throws a headbutt at @C$N@W, but misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou grab @c$N@W by the shoulders and slam your head into $S chest!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@C$n@W grabs YOU by the shoulders and slams $s head into YOUR chest!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$n@W grabs @c$N@W by the shoulders and slams $s head into @c$N's@W chest!@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou grab @c$N@W by the shoulders and slam your head into $S face!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@C$n@W grabs YOU by the shoulders and slams $s head into YOUR face!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$n@W grabs @c$N@W by the shoulders and slams $s head into @c$N's@W face!@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                ...
                case 3:
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou grab @c$N@W and barely manage to slam your head into $S leg!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@C$n@W grabs YOU and barely manages to slam $s head into YOUR leg!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$n@W grabs @c$N@W and barely manages to slam $s head into @c$N's@W leg!@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    ...
                    break;
                case 5: /* Weak */
                    act("@WYou grab @c$N@W and barely manage to slam your head into $S arm!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@C$n@W grabs YOU and barely manages to slam $s head into YOUR arm!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$n@W grabs @c$N@W and barely manages to slam $s head into @c$N's@W arm!@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
            ...
            if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD)) {
                act("@c$N's@W fireshield burns your head!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n's@W head is burned by your fireshield!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n's@W head is burned by @C$N's@W fireshield!@n", 1, ch, 0, vict, TO_NOTVICT);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou headbutt $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W headbutt $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your bash before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c bash before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c bash before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your bash with an attack of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W bash with an attack of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W bash with an attack of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W blocks your bash!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou block @C$n's@W bash!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W bash!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 3, skill, attperc);
                    ...
                    act("@C$N@W dodges your bash!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W bash!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W bash!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your bash misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W throws a bash at you, but thankfully misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W throws a bash at @C$N@W, but misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD)) {
                act("@c$N's@W fireshield burns your body!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n's@W body is burned by your fireshield!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n's@W body is burned by @C$N's@W fireshield!@n", 1, ch, 0, vict, TO_NOTVICT);
                dmg = GET_MAX_MANA(vict) * 0.02;
                LASTATK(vict) += 1000;
                hurt(0, 0, vict, ch, NULL, dmg, 0);
                if (GET_BONUS(ch, BONUS_FIREPRONE)) {
            ...
            if (rand_number(1, 5) >= 5) {
                if (AFF_FLAGGED(ch, AFF_FLYING)) {
                    act("@w$N@w is knocked out of the air!@n", 1, vict, 0, ch, TO_CHAR);
                    act("@wYou are knocked out of the air!@n", 1, vict, 0, ch, TO_VICT);
                    act("@w$N@w is knocked out of the air!@n", 1, vict, 0, ch, TO_NOTVICT);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou bash $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W bash $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Seishou Enko before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Seishou Enko before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Seishou Enko before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                ...
                act("@C$N@c disappears, trying to avoid your Seishou Enko but your zanzoken is faster!@n", 0, ch, 0,
                    vict, TO_CHAR);
                act("@cYou zanzoken to avoid the Seishou Enko but @C$n's@c zanzoken is faster!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, trying to avoid @C$n's@c Seishou Enko but @C$n's@c zanzoken is faster!@n",
                    0, ch, 0, vict, TO_NOTVICT);
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
            }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Seishou Enko, letting it fly harmlessly by!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Seishou Enko, letting it fly harmlessly by!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Seishou Enko, letting it fly harmlessly by!@n", 0, ch, 0,
                        vict, TO_NOTVICT);
                    pcost(ch, attperc / 4, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                    ...
                    act("@WYou can't believe it but your Seishou Enko misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Seishou Enko at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Seishou Enko at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc / 4, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                ...
                act("@WYou can't believe it but your Seishou Enko misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Seishou Enko at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Seishou Enko at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc / 4, 0);
            }
            hurt(0, 0, ch, vict, NULL, 0, 1);
            return;
        ...
        dmg = damtype(ch, 10, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Seishou Enko at $p@W!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a Seishou Enko at $p@W!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
...
ACMD(do_throw) {
    ...
    int odam = 0, miss = 1, perc = 0, prob = 0, perc2 = 0, grab = 0;
    int64_t damage;
    ...
    if (obj) {
        ...
        if (GET_OBJ_WEIGHT(obj) + ROOM_GRAVITY(IN_ROOM(ch)) > CAN_CARRY_W(ch)) {
            ...
            int penalty = 0, chance = axion_dice(0) + axion_dice(0), wtype = 0, wlvl = 1, multithrow = 1;
            handle_cooldown(ch, 5);
            ...
            if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
                GET_MOVE(vict) >= 1 && GET_POS(vict) != POS_SLEEPING) {
                if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) &&
                                                       GET_SPEEDI(ch) + rand_number(1, 5) <
                                                       GET_SPEEDI(vict) + rand_number(1, 5))) {
                    act("@C$N@c disappears, avoiding your $p before reappearing!@n", 1, ch, obj, vict, TO_CHAR);
                    act("@cYou disappear, avoiding @C$n's@c $p before reappearing!@n", 1, ch, obj, vict, TO_VICT);
                    act("@C$N@c disappears, avoiding @C$n's@c $p before reappearing!@n", 1, ch, obj, vict,
                        TO_NOTVICT);
                    COMBO(ch) = -1;
                    COMBHITS(ch) = 0;
                    ...
                    act("@C$N@c disappears, trying to avoid your attack but your zanzoken is faster!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@cYou zanzoken to avoid the attack but @C$n's@c zanzoken is faster!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@c disappears, trying to avoid @C$n's@c attack but @C$n's@c zanzoken is faster!@n", 0,
            ...
            if (perc - (perc2 / 10) < prob) {
                if (OBJ_FLAGGED(obj, ITEM_ICE) && IS_DEMON(vict)) {
                    act("You throw $p at $N@n, but it melts before touching $M!", 1, ch, obj, vict, TO_CHAR);
                    act("$n@n throws $p at $N@n, but it melts before touching $M!", 1, ch, obj, vict, TO_NOTVICT);
                    act("$n@n throws $p at you, but it melts before touching you!", 1, ch, obj, vict, TO_VICT);
                    GET_MOVE(ch) -= ((GET_MAX_HIT(ch) / 100) + GET_OBJ_WEIGHT(obj));
                    extract_obj(obj);
                    return;
                }
                if (perc2 > 0) {
                    act("You throw $p at $N@n, but $E manages to dodge it easily!", 1, ch, obj, vict, TO_CHAR);
                    act("$n@n throws $p at $N@n, but $E manages to dodge it easily!", 1, ch, obj, vict, TO_NOTVICT);
                    act("$n@n throws $p at you, but you easily dodge it.", 1, ch, obj, vict, TO_VICT);
                } else if (perc2 <= 0) {
                    act("You throw $p at $N@n, but unfortunatly miss!", 1, ch, obj, vict, TO_CHAR);
                    act("$n@n throws $p at $N@n, but unfortunatly misses!", 1, ch, obj, vict, TO_NOTVICT);
                    act("$n@n throws $p at you, but thankfully misses you.", 1, ch, obj, vict, TO_VICT);
                }
                GET_MOVE(ch) -= ((GET_MAX_HIT(ch) / 100) + GET_OBJ_WEIGHT(obj));
                ...
                if (!GET_EQ(ch, WEAR_WIELD1) && !GET_EQ(ch, WEAR_WIELD2))
                    perc += 20;
                if (perc + GET_CHA(ch) >= chance + penalty && multithrow == 1 && GET_HIT(vict) > 1 &&
                    ch->throws > 1) {
                    do_throw(ch, argument, 0, 0);
                    ch->throws -= 1;
                } else if (perc + GET_CHA(ch) >= chance + penalty && multithrow == 1 && GET_HIT(vict) > 1 &&
                           ch->throws == 1) {
                    do_throw(ch, argument, 0, 0);
                    ch->throws = -1;
                } else {
            ...
            if (!IS_NPC(ch) && PRF_FLAGGED(ch, PRF_ENERGIZE) && GET_MANA(ch) >= GET_MAX_MANA(ch) * 0.02) {
                ...
                act("You throw $p at $N@n full speed, and watch it smash into $M!", 1, ch, obj, vict, TO_CHAR);
                act("$n@n throws $p at $N@n full speed, and watches it smash into $M!", 1, ch, obj, vict,
                    TO_NOTVICT);
                act("$n@n throws $p at you full speed. You reel as it smashes into your body!", 1, ch, obj, vict,
                    TO_VICT);
            } else if (wtype == 1 || wtype == 2) {
                act("You pull out and throw $p at $N@n full speed, and watch it sink into $M!", 1, ch, obj, vict,
                    TO_CHAR);
                act("$n@n pulls out and throws $p at $N@n full speed, and watches it sink into $M!", 1, ch, obj,
                    vict, TO_NOTVICT);
                act("$n@n pulls out and throws $p at you full speed. You reel as it sink into your body!", 1, ch,
                    obj, vict, TO_VICT);
            } else if (wtype == 3) {
                act("You swing $p overhead and throw it at $N@n full speed, and watch it slam into $M!", 1, ch, obj,
                    vict, TO_CHAR);
                act("$n@n swings $p overhead and throws it at $N@n full speed, and watches it slam into $M!", 1, ch,
                    obj, vict, TO_NOTVICT);
                act("$n@n swings $p overhead and throws it at you full speed. You reel as it slam into your body!",
                    1, ch, obj, vict, TO_VICT);
            } else if (wtype == 4) {
                act("You bring $p over your shoulder and throw it at $N@n full speed, and watch it sink into $M!", 1,
                    ch, obj, vict, TO_CHAR);
                ...
                act("You pull out and throw $p at $N@n full speed, and watch it hit $M!", 1, ch, obj, vict, TO_CHAR);
                act("$n@n pulls out and throws $p at $N@n full speed, and watches it hit $M!", 1, ch, obj, vict,
                    TO_NOTVICT);
                act("$n@n pulls out and throws $p at you full speed. You reel as it hits your body!", 1, ch, obj,
                    vict, TO_VICT);
            }
            if (!OBJ_FLAGGED(obj, ITEM_UNBREAKABLE)) {
            ...
            if ((GET_OBJ_VAL(obj, VAL_ALL_HEALTH) - odam) <= 0 && !OBJ_FLAGGED(obj, ITEM_UNBREAKABLE)) {
                act("You smile as $p breaks on $N's@n face!", 1, ch, obj, vict, TO_CHAR);
                act("$n@n smiles as $p breaks on $N's@n face!", 1, ch, obj, vict, TO_NOTVICT);
                act("$n@n smiles as $p breaks on your face!", 1, ch, obj, vict, TO_VICT);
                TOGGLE_BIT_AR(GET_OBJ_EXTRA(obj), ITEM_BROKEN);
            } else if (GET_DEX(ch) >= axion_dice(0)) {
                if (IS_ANDROID(vict) || IS_WARHOST(vict)) {
                    act("@RSome pieces of metal are sent flying!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@RSome pieces of metal are sent flying!@n", 1, ch, 0, vict, TO_VICT);
                    act("@RSome pieces of metal are sent flying!@n", 1, ch, 0, vict, TO_NOTVICT);
                } else if (IS_MAJIN(vict)) {
                    act("@RA wide hole is left in $S gooey flesh!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@RA wide hole is left is your gooey flesh!@n", 1, ch, 0, vict, TO_VICT);
                    act("@RA wide hole is left in $N@R's gooey flesh@n", 1, ch, 0, vict, TO_NOTVICT);
                } else {
                    act("@RBlood flies out from the impact!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@RBlood flies out from the impact!@n", 1, ch, 0, vict, TO_VICT);
                    act("@RBlood flies out from the impact!@n", 1, ch, 0, vict, TO_NOTVICT);
                }
                if (OBJ_FLAGGED(obj, ITEM_ICE)) {
                    if (!IS_ANDROID(vict) && !IS_ICER(vict)) {
                        ...
                        if (GET_MOVE(vict) < 0)
                            GET_MOVE(vict) = 0;
                        act("@mYou lose some stamina to the @ccold@m!@n", 1, ch, 0, vict, TO_VICT);
                        act("@C$N@m loses some stamina to the @ccold@m!@n", 1, ch, 0, vict, TO_CHAR);
                        act("@C$N@m loses some stamina to the @ccold@m!@n", 1, ch, 0, vict, TO_NOTVICT);
                    }
                }
            ...
            if (hot == 1) {
                if (!IS_DEMON(vict) && !GET_BONUS(vict, BONUS_FIREPROOF)) {
                    act("@R$N@R is burned by it!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@RYou are burned by it!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@R is burned by it!@n", 1, ch, 0, vict, TO_NOTVICT);
                    SET_BIT_AR(AFF_FLAGS(vict), AFF_BURNED);
                    damage += damage * 0.4;
                }
            }
            ...
            if (!GET_EQ(ch, WEAR_WIELD1) && !GET_EQ(ch, WEAR_WIELD2))
                perc += 12;
            if (perc + GET_CHA(ch) >= chance + penalty && multithrow == 1 && GET_HIT(vict) > 1 && ch->throws > 1) {
                do_throw(ch, argument, 0, 0);
                ch->throws -= 1;
            } else if (perc + GET_CHA(ch) >= chance + penalty && multithrow == 1 && GET_HIT(vict) > 1 &&
                       ch->throws == 1) {
    ...
    if (tch) {
        ...
        if (grab == 0) {
            act("@WYou try to grab @C$N@W and throw them, but they manage to dodge your attempt!@n", 1, ch, 0, tch,
                TO_CHAR);
            act("@C$n@W tries to @RGRAB@W you and @RTHROW@W you, but you manage to dodge the attempt!@n", 1, ch, 0,
                tch, TO_VICT);
            act("@C$n@W tries to @RGRAB@W @c$N@W and @RTHROW@W $M, but $E manages to dodge the attempt!@n", 1, ch, 0,
                tch, TO_NOTVICT);
            ...
            if (perc - (perc2 / 10) < prob) {
                if (perc2 > 0) {
                    act("@WYou grab @C$N@W and spinning around quickly you throw $M!@n", 1, ch, 0, tch, TO_CHAR);
                    act("@C$n@W grabs YOU and spinning around quickly $e throws you!@n", 1, ch, 0, tch, TO_VICT);
                    act("@C$n@W grabs @c$N@W and spinning around quickly $e throws $M!@n", 1, ch, 0, tch,
                        TO_NOTVICT);
                ...
                act("@W--@R$N@W--@n", 1, ch, 0, vict, TO_CHAR);
                act("@W--@R$N@W--@n", 1, tch, 0, vict, TO_CHAR);
                act("@W--@RYOU@W--@n", 1, vict, 0, 0, TO_CHAR);
                hurt(0, 0, ch, vict, NULL, 0, 0);
                act("@W--@R$N@W--@n", 1, ch, 0, tch, TO_CHAR);
                act("@W--@R$N@W--@n", 1, vict, 0, tch, TO_CHAR);
                act("@W--@RYOU@W--@n", 1, tch, 0, 0, TO_CHAR);
                hurt(0, 0, ch, tch, NULL, 0, 0);
                return;
            } else if (perc - (perc2 / 10) >= prob) {
                miss = 0;
            ...
            if (miss == 0) {
                act("@WYou grab @C$N@W and spinning around quickly you throw $M!@n", 1, ch, 0, tch, TO_CHAR);
                act("@C$n@W grabs YOU and spinning around quickly $e throws you!@n", 1, ch, 0, tch, TO_VICT);
                act("@C$n@W grabs @c$N@W and spinning around quickly $e throws $M!@n", 1, ch, 0, tch, TO_NOTVICT);
                act("@WThrown through the air, YOU fly at @c$N@W and smash into $M!@n", 1, tch, 0, vict, TO_CHAR);
                act("@WThrown through the air, @C$n@W flies at YOU and smashes into YOU!@n", 1, tch, 0, vict,
                    TO_VICT);
                act("@WThrown through the air, @C$n@W flies at @c$N@W and smashes into $M!@n", 1, tch, 0, vict,
                    TO_NOTVICT);
                act("@W--@R$N@W--@n", 1, ch, 0, vict, TO_CHAR);
                act("@W--@R$N@W--@n", 1, tch, 0, vict, TO_CHAR);
                act("@W--@RYOU@W--@n", 1, vict, 0, 0, TO_CHAR);
...
ACMD(do_selfd) {
    ...
    if (!PLR_FLAGGED(ch, PLR_SELFD)) {
        ...
        GET_SUPP(ch) = 0;
        GET_SUPPRESS(ch) = 0;
        act("@RYou EXPLODE! The explosion concentrates on @r$N@R, engulfing $M in a sphere of deadly energy!@n", 1,
            ch, 0, tch, TO_CHAR);
        act("@R$n EXPLODES! The explosion concentrates on YOU, engulfing your body in a sphere of deadly energy!@n",
            1, ch, 0, tch, TO_VICT);
        act("@R$n EXPLODES! The explosion concentrates on @r$N@R, engulfing $M in a sphere of deadly energy!@n", 1,
            ch, 0, tch, TO_NOTVICT);
        ...
        for (tch = world[IN_ROOM(ch)].people; tch; tch = next_v) {
            ...
            if (MOB_FLAGGED(tch, MOB_NOKILL)) {
                ...
                act("@r$N@R is caught in the explosion!@n", 1, ch, 0, tch, TO_CHAR);
                act("@RYou are caught in the explosion!@n", 1, ch, 0, tch, TO_VICT);
                act("@r$N@R is caught in the explosion!@n", 1, ch, 0, tch, TO_NOTVICT);
                hurt(0, 0, ch, tch, NULL, dmg, 1);
            }
        }
        if (PLR_FLAGGED(ch, PLR_IMMORTAL)) {
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Water Razor before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Water Razor before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Water Razor before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                ...
                act("@C$N@c disappears, trying to avoid your Water Razor but your zanzoken is faster!@n", 0, ch, 0,
                    vict, TO_CHAR);
                act("@cYou zanzoken to avoid the Water Razor but @C$n's@c zanzoken is faster!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, trying to avoid @C$n's@c Water Razor but @C$n's@c zanzoken is faster!@n", 0,
                    ch, 0, vict, TO_NOTVICT);
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
            }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Water Razor, letting it fly harmlessly by!@n", 0, ch, 0, vict,
                        TO_CHAR);
                    act("@WYou dodge @C$n's@W Water Razor, letting it fly harmlessly by!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Water Razor, letting it fly harmlessly by!@n", 0, ch, 0,
                        vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                    ...
                    act("@WYou can't believe it but your Water Razor misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Water Razor at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Water Razor at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                }
            } else {
                act("@WYou can't believe it but your Water Razor misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Water Razor at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Water Razor at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
...
ACMD(do_spike) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > rand_number(1, 130)) {
                    act("@C$N@W moves quickly and blocks your water spikes!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W water spikes!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W water spikes!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your water spikes, letting them slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W water spikes, letting them slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your water spikes miss, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fire water spikes at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fire water spikes at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                ...
                act("@WYou can't believe it but your water spikes miss, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires water spikes at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires water spikes at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 43, skill, attperc);
        dmg /= 10;
        act("@WYou fire water spikes at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires water spikes at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3) {
            WAIT_STATE(ch, PULSE_3SEC);
        }
        hurt(0, 0, ch, NULL, obj, dmg, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Koteiru Bakuha before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Koteiru Bakuha before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Koteiru Bakuha before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                ...
                act("@C$N@c disappears, trying to avoid your Koteiru Bakuha but your zanzoken is faster!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@cYou zanzoken to avoid the Koteiru Bakuha but @C$n's@c zanzoken is faster!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, trying to avoid @C$n's@c Koteiru Bakuha but @C$n's@c zanzoken is faster!@n",
                    0, ch, 0, vict, TO_NOTVICT);
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
            }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Koteiru Bakuha, letting it fly harmlessly by!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Koteiru Bakuha, letting it fly harmlessly by!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Koteiru Bakuha, letting it fly harmlessly by!@n", 0, ch,
                        0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                    ...
                    act("@WYou can't believe it but your Koteiru Bakuha misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Koteiru Bakuha at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Koteiru Bakuha at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                ...
                act("@WYou can't believe it but your Koteiru Bakuha misses, flying through the air harmlessly!@n",
                    0, ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Koteiru Bakuha at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Koteiru Bakuha at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
            }
            hurt(0, 0, ch, vict, NULL, 0, 1);
            return;
            ...
            if (vict) {
                if (GET_HIT(vict) > 1) {
                    if (rand_number(1, 4) == 1 && !AFF_FLAGGED(vict, AFF_FROZEN) && !IS_DEMON(vict)) {
                        act("@CYour body completely freezes!@n", 1, vict, 0, 0, TO_CHAR);
                        act("@c$n's@C body completely freezes!@n", 1, vict, 0, 0, TO_ROOM);
        ...
        dmg = damtype(ch, 48, skill, attperc);
        dmg /= 10;
        act("@WYou fire Koteiru Bakuha at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires Koteiru Bakuha at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Hell Spiral before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Hell Spiral before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Hell Spiral before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                ...
                act("@C$N@c disappears, trying to avoid your Hell Spiral but your zanzoken is faster!@n", 0, ch, 0,
                    vict, TO_CHAR);
                act("@cYou zanzoken to avoid the Hell Spiral but @C$n's@c zanzoken is faster!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, trying to avoid @C$n's@c Hell Spiral but @C$n's@c zanzoken is faster!@n", 0,
                    ch, 0, vict, TO_NOTVICT);
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
            }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Hell Spiral, letting it fly harmlessly by!@n", 0, ch, 0, vict,
                        TO_CHAR);
                    act("@WYou dodge @C$n's@W Hell Spiral, letting it fly harmlessly by!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Hell Spiral, letting it fly harmlessly by!@n", 0, ch, 0,
                        vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                    ...
                    act("@WYou can't believe it but your Hell Spiral misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Hell Spiral at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Hell Spiral at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                }
            } else {
                act("@WYou can't believe it but your Hell Spiral misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Hell Spiral at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Hell Spiral at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 49, skill, attperc);
        dmg /= 10;
        act("@WYou fire Hell Spiral at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires Hell Spiral at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Star Breaker before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Star Breaker before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Star Breaker before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                ...
                act("@C$N@c disappears, trying to avoid your Star Breaker but your zanzoken is faster!@n", 0, ch, 0,
                    vict, TO_CHAR);
                act("@cYou zanzoken to avoid the Star Breaker but @C$n's@c zanzoken is faster!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, trying to avoid @C$n's@c Star Breaker but @C$n's@c zanzoken is faster!@n",
                    0, ch, 0, vict, TO_NOTVICT);
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
            }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > rand_number(1, 130)) {
                    act("@C$N@W moves quickly and blocks your Star Breaker!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Star Breaker!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Star Breaker!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    dmg = damtype(ch, 10, skill, attperc);
                    dmg /= 4;
                    hurt(0, 0, ch, vict, NULL, dmg, 1);
                    ...
                    act("@C$N@W manages to dodge your Star Breaker, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Star Breaker, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your Star Breaker misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Star Breaker at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Star Breaker at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
                ...
                act("@WYou can't believe it but your Star Breaker misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Star Breaker at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Star Breaker at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
            }
            hurt(0, 0, ch, vict, NULL, 0, 1);
            return;
        ...
        dmg = damtype(ch, 46, skill, attperc);
        dmg /= 10;
        act("@WYou fire Star Breaker at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires Star Breaker at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
