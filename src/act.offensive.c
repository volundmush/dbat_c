...
ACMD(do_galikgun) {
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            GET_MOVE(vict) >= 1 && GET_POS(vict) != POS_SLEEPING) {
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Galik Gun before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Galik Gun before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Galik Gun before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                ...
                act("@C$N@c disappears, trying to avoid your attack but your zanzoken is faster!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou zanzoken to avoid the attack but @C$n's@c zanzoken is faster!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, trying to avoid @C$n's@c attack but @C$n's@c zanzoken is faster!@n", 0, ch,
                    0, vict, TO_NOTVICT);
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
            }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    act("@C$N@W absorbs your ki attack and all your charged ki with $S hand!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@WYou absorb @C$n's@W ki attack and all $s charged ki with your hand!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W absorbs @c$n's@W ki attack and all $s charged ki with $S hand!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    ...
                    act("@C$N@W moves quickly and blocks your Galik Gun!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Galik Gun!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Galik Gun!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_GALIKGUN) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your Galik Gun, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Galik Gun, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Galik Gun, letting it slam into the surroundings!@n", 0,
                    ...
                    act("@WYou can't believe it but your Galik Gun misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Galik Gun at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Galik Gun at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your Galik Gun misses, flying through the air harmlessly!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a Galik Gun at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Galik Gun at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_GALIKGUN) == 3 && attperc > minimum) {
        ...
        dmg = damtype(ch, 16, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Galik Gun at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a Galik Gun at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Honoo before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Honoo before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Honoo before reappearing!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W moves quickly and blocks your honoo!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W honoo!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W honoo!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_HONOO) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your honoo, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W honoo, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W honoo, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your honoo misses, flying through the air harmlessly!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@C$n@W fires a honoo at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a honoo at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your honoo misses, flying through the air harmlessly!@n", 0, ch, 0,
                    vict, TO_CHAR);
                act("@C$n@W fires a honoo at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a honoo at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_HONOO) == 3 && attperc > minimum) {
        ...
        if (GET_OBJ_VNUM(obj) == 79)
            dmg *= 3;
        act("@WYou fire a honoo at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a honoo at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Psychic Blast before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Psychic Blast before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Psychic Blast before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W moves quickly and blocks your psychic blast!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W psychic blast!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W psychic blast!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_PSYBLAST) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your psychic blast, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W psychic blast, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W psychic blast, letting it slam into the surroundings!@n",
                        0, ch, 0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your psychic blast misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a psychic blast at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a psychic blast at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your psychic blast misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a psychic blast at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a psychic blast at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_PSYBLAST) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
            ...
            if (!AFF_FLAGGED(vict, AFF_SHOCKED) && rand_number(1, 4) == 4 && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                act("@MYour mind has been shocked!@n", 1, vict, 0, 0, TO_CHAR);
                act("@M$n@m's mind has been shocked!@n", 1, vict, 0, 0, TO_ROOM);
        ...
        dmg = damtype(ch, 20, skill, attperc);
        dmg /= 10;
        act("@WYou fire a psychic blast at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a psychic blast at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_tslash) {
    ...
    if (!HAS_ARMS(ch)) {
        ...
        if (GET_LIMBCOND(ch, 1) < 0) {
            act("@RYour right arm has fallen apart!@n", 1, ch, 0, 0, TO_CHAR);
            act("@r$n@R's right arm has fallen apart!@n", 1, ch, 0, 0, TO_ROOM);
        }
        ...
        if (GET_LIMBCOND(ch, 2) < 0) {
            act("@RYour left arm has fallen apart!@n", 1, ch, 0, 0, TO_CHAR);
            act("@r$n@R's left arm has fallen apart!@n", 1, ch, 0, 0, TO_ROOM);
        }
    }
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Twin Slash before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Twin Slash before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Twin Slash before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your twin slash!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W twin slash!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W twin slash!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_TSLASH) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your twin slash, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W twin slash, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W twin slash, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your twin slash misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a twin slash at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a twin slash at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your twin slash misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a twin slash at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a twin slash at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_TSLASH) == 3 && attperc > minimum) {
            ...
            switch (hitspot) {
                case 1:
                    ...
                    if ((IS_ICER(vict) || IS_BIO(vict)) && PLR_FLAGGED(vict, PLR_TAIL)) {
                        act("@rYou cut off $S tail!@n", 1, ch, 0, vict, TO_CHAR);
                        act("@rYour tail is cut off!@n", 1, ch, 0, vict, TO_VICT);
                        act("@R$N@r's tail is cut off!@n", 1, ch, 0, vict, TO_NOTVICT);
                ...
                case 2: /* Critical */
                    ...
                    if (dmg > GET_MAX_HIT(vict) / 5 && (!IS_MAJIN(vict) && !IS_BIO(vict))) {
                        act("@R$N@r has $S head cut off by the attack!@n", 1, ch, 0, vict, TO_CHAR);
                        act("@rYou have your head cut off by the attack!@n", 1, ch, 0, vict, TO_VICT);
                        act("@R$N@r has $S head cut off by the attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                        ...
                        if (GET_SKILL(vict, SKILL_REGENERATE) > rand_number(1, 101) &&
                            ...
                            act("@R$N@r has $S head cut off by the attack but regenerates a moment later!@n", 1, ch,
                                0, vict, TO_CHAR);
                            act("@rYou have your head cut off by the attack but regenerate a moment later!@n", 1, ch,
                                0, vict, TO_VICT);
                            act("@R$N@r has $S head cut off by the attack but regenerates a moment later!@n", 1, ch,
                                0, vict, TO_NOTVICT);
                            GET_MANA(vict) -= GET_MAX_MANA(vict) / 40;
                ...
                case 4: /* Weak */
                    ...
                    if (rand_number(1, 100) >= 70 && !IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                        if (GET_LIMBCOND(vict, 2) > 0 && !is_sparring(ch) && rand_number(1, 2) == 2) {
                            act("@RYour attack severs $N's left arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@R$n's attack severs your left arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@R$N's left arm is severered in the attack!@n", 1, ch, 0, vict, TO_VICT);
                            GET_LIMBCOND(vict, 2) = 0;
                            remove_limb(vict, 2);
                        } else if (GET_LIMBCOND(vict, 1) > 0 && !is_sparring(ch)) {
                            act("@RYour attack severs $N's right arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@R$n's attack severs your right arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@R$N's right arm is severered in the attack!@n", 1, ch, 0, vict, TO_VICT);
                ...
                case 5: /* Weak 2 */
                    ...
                    if (rand_number(1, 100) >= 70 && !IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                        if (GET_LIMBCOND(vict, 4) > 0 && !is_sparring(ch) && rand_number(1, 2) == 2) {
                            act("@RYour attack severs $N's left leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@R$n's attack severs your left leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@R$N's left leg is severered in the attack!@n", 1, ch, 0, vict, TO_VICT);
                            GET_LIMBCOND(vict, 4) = 0;
                            remove_limb(vict, 4);
                        } else if (GET_LIMBCOND(vict, 3) > 0 && !is_sparring(ch)) {
                            act("@RYour attack severs $N's right leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@R$n's attack severs your right leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@R$N's right leg is severered in the attack!@n", 1, ch, 0, vict, TO_VICT);
        ...
        dmg = damtype(ch, 19, skill, attperc);
        dmg /= 10;
        act("@WYou fire a twin slash at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a twin slash at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Eraser Cannon before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Eraser Cannon before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Eraser Cannon before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W moves quickly and blocks your eraser cannon!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W eraser cannon!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W eraser cannon!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    if (GET_SKILL(ch, SKILL_ERASER) >= 100) {
                        GET_MANA(ch) += (GET_MAX_MANA(ch) * attperc) * 0.15;
                    ...
                    act("@C$N@W manages to dodge your eraser cannon, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W eraser cannon, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your eraser cannon misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a eraser cannon at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a eraser cannon at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your eraser cannon misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a eraser cannon at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a eraser cannon at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
                if (GET_SKILL(ch, SKILL_ERASER) >= 100) {
                    GET_MANA(ch) += (GET_MAX_MANA(ch) * attperc) * 0.15;
                } else if (GET_SKILL(ch, SKILL_ERASER) >= 60) {
        ...
        dmg = damtype(ch, 18, skill, attperc);
        dmg /= 10;
        act("@WYou fire a eraser cannon at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a eraser cannon at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
        if (GET_SKILL(ch, SKILL_ERASER) >= 100) {
            GET_MANA(ch) += (GET_MAX_MANA(ch) * attperc) * 0.15;
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Psychic Barrage before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Psychic Barrage before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Psychic Barrage before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your psychic barrage!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W psychic barrage!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W psychic barrage!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your psychic barrage, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W psychic barrage, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your psychic barrage misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a psychic barrage at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a psychic barrage at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your psychic barrage misses, flying through the air harmlessly!@n",
                    0, ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a psychic barrage at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a psychic barrage at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
            ...
            if (!AFF_FLAGGED(vict, AFF_MBREAK) && rand_number(1, 4) == 4 && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                act("@mYour mind's eye has been shattered, you can't charge ki until you recover!@n", 1, vict, 0, 0,
                    TO_CHAR);
                act("@M$n@m's mind has been damaged by the attack!@n", 1, vict, 0, 0, TO_ROOM);
        ...
        dmg = damtype(ch, 31, skill, attperc);
        dmg /= 10;
        act("@WYou fire a psychic barrage at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a psychic barrage at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_genki) {
    ...
    for (friend = world[IN_ROOM(ch)].people; friend; friend = next_v) {
        ...
        if (AFF_FLAGGED(friend, AFF_GROUP) &&
            (friend->master == ch || ch->master == friend || friend->master == ch->master)) {
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Spirit Ball before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Spirit Ball before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Spirit Ball before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W deflects your Spirit Ball, sending it flying away!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou deflect @C$n's@W Spirit Ball sending it flying away!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W deflects @c$n's@W Spirit Ball sending it flying away!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks the Spirit Ball!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Spirit Ball!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Spirit Ball!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your Spirit Ball, letting it slam into the surroundings!@n", 1, ch,
                        0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Spirit Ball, letting it slam into the surroundings!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Spirit Ball, letting it slam into the surroundings!@n", 1,
                        ch, 0, vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your spirit ball misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a spirit ball at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a spirit ball at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your spirit ball misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a spirit ball at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a spirit ball at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                dodge_ki(ch, vict, 2, 39, skill, SKILL_SPIRITBALL); /* Effects on the room from dodging a ki attack
        ...
        dmg = damtype(ch, 39, skill, attperc);
        dmg /= 10;
        act("@WYou fire a spirit ball at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a spirit ball at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Deathball before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Deathball before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Deathball before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (dge > axion_dice(10)) {
                    act("@C$N@W manages to dodge your deathball, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W deathball, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W deathball, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your deathball misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a deathball at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a deathball at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your deathball misses, flying through the air harmlessly!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a deathball at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a deathball at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 38, skill, attperc);
        dmg /= 10;
        act("@WYou fire a deathball at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a deathball at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Phoenix Slash before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Phoenix Slash before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Phoenix Slash before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your Phoenix Slash!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Phoenix Slash!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Phoenix Slash!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your Phoenix Slash, letting it fly harmlessly by!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Phoenix Slash, letting it letting it fly harmlessly by!@n", 0, ch, 0,
                        vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Phoenix Slash, letting it fly harmlessly by!@n", 0, ch, 0,
                        vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your Phoenix Slash misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Phoenix Slash at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Phoenix Slash at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your Phoenix Slash misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Phoenix Slash at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Phoenix Slash at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        if (GET_OBJ_VNUM(obj) == 79)
            dmg *= 3;
        act("@WYou fire a Phoenix Slash at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a Phoenix Slash at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Big Bang before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Big Bang before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Big Bang before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your Big Bang!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Big Bang!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Big Bang!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your Big Bang, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Big Bang, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Big Bang, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your Big Bang misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Big Bang at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Big Bang at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your Big Bang misses, flying through the air harmlessly!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a Big Bang at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Big Bang at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 36, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Big Bang at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a Big Bang at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Scatter Shot before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Scatter Shot before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Scatter Shot before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks every kiball of your scatter shot!@n", 0, ch, 0, vict,
                        TO_CHAR);
                    act("@WYou move quickly and block every kiball of @C$n's@W scatter shot!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W moves quickly and blocks every kiball of @c$n's@W scatter shot!@n", 0, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your scatter shot kiballs, letting them slam into the surroundings!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W scatter shot kiballs, letting them slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but all the kiballs of your scatter shot miss, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires scatter shot kiballs at you, but they miss!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires scatter shot kiballs at @C$N@W, but somehow they miss!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
        ...
        dmg = damtype(ch, 35, skill, attperc);
        dmg /= 10;
        act("@WYou fire a scatter shot at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a scatter shot at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Balefire before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Balefire before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Balefire before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    ...
                    act("@C$N@W manages to dodge your balefire, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W balefire, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W balefire, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but all of your balefire misses, flying through the air harmlessly!@n",
                    0, ch, 0, vict, TO_CHAR);
                act("@C$n@W fires balefire at you, but they miss!@n ", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires balefire at @C$N@W, but somehow they miss!@n ", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 35, skill, attperc);
        dmg /= 10;
        act("@WYou fire balefire at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires balefire at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (count <= 0) {
        ...
        for (vict = world[IN_ROOM(ch)].people; vict; vict = next_v) {
            ...
            if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
                GET_MOVE(vict) >= 1 && GET_POS(vict) != POS_SLEEPING) {
                hits++;
                act("@C$N@c disappears, avoiding the beam chasing $M!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding the beam chasing you!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding the beam chasing $M!@n", 0, ch, 0, vict, TO_NOTVICT);
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                pcost(vict, 0, GET_MAX_HIT(vict) / 200);
                hurt(0, 0, ch, vict, NULL, 0, 1);
                continue;
                ...
                hits++;
                act("@c$N@W manages to escape the attack!@n", 1, ch, 0, vict, TO_CHAR);
                act("@WYou manage to escape the attack!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$N@W manages to escape the attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                improve_skill(vict, SKILL_DODGE, 0);
                hurt(0, 0, ch, vict, NULL, 0, 1);
                continue;
            } else {
                hits++;
                act("@R$N@r is slammed by one of the beams!@n", 1, ch, 0, vict, TO_CHAR);
                act("@RYou are slammed by one of the beams!@n", 1, ch, 0, vict, TO_VICT);
                act("@R$N@r is slammed by one of the beams!@n", 1, ch, 0, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, NULL, dmg, 1);
                continue;
            }
        } /* Hitting targets! */
        ...
        if (count < 5 && !ROOM_FLAGGED(IN_ROOM(ch), ROOM_SPACE)) {
            ...
            if (SECT(IN_ROOM(ch)) != SECT_INSIDE) {
                ...
                switch (rand_number(1, 8)) {
                    case 1:
                        act("Debris is thrown into the air and showers down thunderously!", 1, ch, 0, 0, TO_CHAR);
                        act("Debris is thrown into the air and showers down thunderously!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    case 2:
                        ...
                        break;
                    case 3:
                        act("A cloud of dust envelopes the entire area!", 1, ch, 0, 0, TO_CHAR);
                        act("A cloud of dust envelopes the entire area!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    case 4:
                        act("The surrounding area roars and shudders from the impact!", 1, ch, 0, 0, TO_CHAR);
                        act("The surrounding area roars and shudders from the impact!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    case 5:
                        act("The ground shatters apart from the stress of the impact!", 1, ch, 0, 0, TO_CHAR);
                        act("The ground shatters apart from the stress of the impact!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    case 6:
            ...
            if (SECT(IN_ROOM(ch)) == SECT_UNDERWATER) {
                switch (rand_number(1, 3)) {
                    case 1:
                        act("The water churns violently!", 1, ch, 0, 0, TO_CHAR);
                        act("The water churns violently!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    case 2:
                        act("Large bubbles rise from the movement!", 1, ch, 0, 0, TO_CHAR);
                        act("Large bubbles rise from the movement!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    case 3:
                        act("The water collapses in on the hole created!", 1, ch, 0, 0, TO_CHAR);
                        act("The water collapses in on the hole create!", 1, ch, 0, 0, TO_ROOM);
                        break;
                }
            }
            if (SECT(IN_ROOM(ch)) == SECT_WATER_SWIM || SECT(IN_ROOM(ch)) == SECT_WATER_NOSWIM) {
                switch (rand_number(1, 3)) {
                    case 1:
                        act("A huge column of water erupts from the impact!", 1, ch, 0, 0, TO_CHAR);
                        act("A huge column of water erupts from the impact!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    case 2:
                        act("The impact briefly causes a swirling vortex of water!", 1, ch, 0, 0, TO_CHAR);
                        act("The impact briefly causes a swirling vortex of water!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    case 3:
                        act("A huge depression forms in the water and erupts into a wave from the impact!", 1, ch, 0,
                            0, TO_CHAR);
                        act("A huge depression forms in the water and erupts into a wave from the impact!", 1, ch, 0,
                            0, TO_ROOM);
                        break;
            ...
            if (SECT(IN_ROOM(ch)) == SECT_INSIDE) {
                ...
                switch (rand_number(1, 8)) {
                    case 1:
                        ...
                        break;
                    case 2:
                        act("The structure of the surrounding room cracks and quakes from the blast!", 1, ch, 0, 0,
                            TO_CHAR);
                        act("The structure of the surrounding room cracks and quakes from the blast!", 1, ch, 0, 0,
                            TO_ROOM);
                        break;
                    case 3:
                        act("Parts of the ceiling collapse, crushing into the floor!", 1, ch, 0, 0, TO_CHAR);
                        act("Parts of the ceiling collapse, crushing into the floor!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    case 4:
                        act("The surrounding area roars and shudders from the impact!", 1, ch, 0, 0, TO_CHAR);
                        act("The surrounding area roars and shudders from the impact!", 1, ch, 0, 0, TO_ROOM);
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        act("The walls of the surrounding room crack in the same instant!", 1, ch, 0, 0, TO_CHAR);
                        act("The walls of the surrounding room crack in the same instant!", 1, ch, 0, 0, TO_ROOM);
                        break;
                    default:
                        /* we want no message for the default */
                        break;
...
ACMD(do_hellspear) {
    ...
    if (count <= 0) {
        ...
        for (vict = world[IN_ROOM(ch)].people; vict; vict = next_v) {
            ...
            if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
                GET_MOVE(vict) >= 1 && GET_POS(vict) != POS_SLEEPING) {
                act("@C$N@c disappears, avoiding the explosion before reappearing elsewhere!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding the explosion before reappearing elsewhere!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding the explosion before reappearing elsewhere!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                ...
                act("@c$N@W manages to escape the explosion!@n", 1, ch, 0, vict, TO_CHAR);
                act("@WYou manage to escape the explosion!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$N@W manages to escape the explosion!@n", 1, ch, 0, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, NULL, 0, 1);
                improve_skill(vict, SKILL_DODGE, 0);
                continue;
            } else {
                act("@R$N@r is caught by the explosion!@n", 1, ch, 0, vict, TO_CHAR);
                act("@RYou are caught by the explosion!@n", 1, ch, 0, vict, TO_VICT);
                act("@R$N@r is caught by the explosion!@n", 1, ch, 0, vict, TO_NOTVICT);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Hell Flash before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Hell Flash before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Hell Flash before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your Hell Flash!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Hell Flash!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Hell Flash!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_HELLFLASH) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your Hell Flash, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Hell Flash, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W Hell Flash, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your Hell Flash misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Hell Flash at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Hell Flash at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_HELLFLASH) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                ...
                act("@WYou can't believe it but your Hell Flash misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a Hell Flash at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a Hell Flash at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_HELLFLASH) == 3 && attperc > minimum) {
        ...
        dmg = damtype(ch, 32, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Hell Flash at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a Hell Flash at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Darkness Dragon Slash before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Darkness Dragon Slash before reappearing!@n", 0, ch, 0,
                    vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Darkness Dragon Slash before reappearing!@n", 0, ch, 0,
                    vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your Darkness Dragon Slash!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Darkness Dragon Slash!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Darkness Dragon Slash!@n", 0, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your Darkness Dragon Slash, letting it fly harmlessly by!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Darkness Dragon Slash, letting it letting it fly harmlessly by!@n", 0,
                        ch, 0, vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your Darkness Dragon Slash misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Darkness Dragon Slash at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Darkness Dragon Slash at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
            ...
            if (rand_number(1, 3) == 3 && !AFF_FLAGGED(vict, AFF_BLIND)) {
                act("@mYou are struck blind temporarily!@n", 1, vict, 0, 0, TO_CHAR);
                act("@c$n@m is struck blind by the attack!@n", 1, vict, 0, 0, TO_ROOM);
                int duration = 1;
        ...
        dmg = damtype(ch, 30, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Darkness Dragon Slash at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a Darkness Dragon Slash at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Crusher Ball before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Crusher Ball before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Crusher Ball before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your crusher ball!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W crusher ball!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W crusher ball!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_CRUSHER) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your crusher ball, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W crusher ball, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your crusher ball misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a crusher ball at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a crusher ball at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_CRUSHER) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                ...
                act("@WYou can't believe it but your crusher ball misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a crusher ball at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a crusher ball at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_CRUSHER) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
            ...
            if (!AFF_FLAGGED(vict, AFF_FLYING) && GET_POS(vict) == POS_STANDING && rand_number(1, 3) == 3) {
                ...
                act("@mYou are knocked out of the air by the attack!", 1, vict, 0, 0, TO_CHAR);
                act("@W$n@m is knocked out of the air by the attack!", 1, vict, 0, 0, TO_ROOM);
        ...
        dmg = damtype(ch, 29, skill, attperc);
        dmg /= 10;
        act("@WYou fire a crusher ball at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a crusher ball at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Final Flash before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Final Flash before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Final Flash before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your final flash!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W final flash!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W final flash!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your final flash, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W final flash, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W final flash, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your final flash misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a final flash at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a final flash at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your final flash misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a final flash at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a final flash at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 28, skill, attperc);
        dmg /= 10;
        act("@WYou fire a final flash at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a final flash at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Special Beam Cannon before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Special Beam Cannon before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Special Beam Cannon before reappearing!@n", 0, ch, 0,
                    vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
            ...
            if (GET_MOVE(vict) > 0) {
                if (dge > axion_dice(10)) {
                    act("@C$N@W manages to dodge your special beam cannon, letting it slam into the surroundings!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W special beam cannon, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your special beam cannon misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a special beam cannon at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a special beam cannon at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
        ...
        dmg = damtype(ch, 27, skill, attperc);
        dmg /= 10;
        act("@WYou fire a special beam cannon at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a special beam cannon at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Tribeam before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Tribeam before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Tribeam before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your tribeam!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W tribeam!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W tribeam!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your tribeam, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W tribeam, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W tribeam, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your tribeam misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a tribeam at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a tribeam at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your tribeam misses, flying through the air harmlessly!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a tribeam at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a tribeam at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 26, skill, attperc);
        dmg /= 10;
        act("@WYou fire a tribeam at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a tribeam at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Kienzan before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Kienzan before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Kienzan before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (dge > axion_dice(10)) {
                    act("@C$N@W manages to dodge your kienzan, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kienzan, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W kienzan, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your kienzan misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a kienzan at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a kienzan at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your kienzan misses, flying through the air harmlessly!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a kienzan at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a kienzan at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
            ...
            switch (hitspot) {
                case 1:
                    ...
                    act("@C$n@W raises $s hand above $s head and pools $s charged ki above $s flattened palm. Slowly a golden spinning disk of energy grows from the ki. With the attack complete $e shouts '@yK@Yi@we@yn@Yz@wa@yn@W!' and throws it! @C$n@W watches as it slices into @c$N@W's body!@n",
                        1, ch, 0, vict, TO_NOTVICT);
                    if (dmg > GET_MAX_HIT(vict) / 5 && (!IS_MAJIN(vict) && !IS_BIO(vict))) {
                        act("@R$N@r is cut in half by the attack!@n", 1, ch, 0, vict, TO_CHAR);
                        act("@rYou are cut in half by the attack!@n", 1, ch, 0, vict, TO_VICT);
                        act("@R$N@r is cut in half by the attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                        die(vict, ch);
                        if (AFF_FLAGGED(ch, AFF_GROUP)) {
                            group_gain(ch, vict);
                        } else {
                        ...
                        if (GET_SKILL(vict, SKILL_REGENERATE) > rand_number(1, 101) &&
                            GET_MANA(vict) >= GET_MAX_MANA(vict) / 40) {
                            act("@R$N@r is cut in half by the attack but regenerates a moment later!@n", 1, ch, 0,
                                vict, TO_CHAR);
                            act("@rYou are cut in half by the attack but regenerate a moment later!@n", 1, ch, 0,
                                vict, TO_VICT);
                            act("@R$N@r is cut in half by the attack but regenerates a moment later!@n", 1, ch, 0,
                                vict, TO_NOTVICT);
                            GET_MANA(vict) -= GET_MAX_MANA(vict) / 40;
                ...
                case 4: /* Weak */
                    ...
                    if (rand_number(1, 100) >= 70 && !IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                        if (GET_LIMBCOND(vict, 2) > 0 && !is_sparring(ch) && rand_number(1, 2) == 2) {
                            act("@RYour attack severes $N's left arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@R$n's attack severes your left arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@R$N's left arm is severed in the attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                            GET_LIMBCOND(vict, 2) = 0;
                            remove_limb(vict, 2);
                        } else if (GET_LIMBCOND(vict, 1) > 0 && !is_sparring(ch)) {
                            act("@RYour attack severes $N's right arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@R$n's attack severes your right arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@R$N's right arm is severed in the attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                            GET_LIMBCOND(vict, 1) = 0;
                            remove_limb(vict, 1);
                        }
                    }
                ...
                case 5: /* Weak 2 */
                    ...
                    if (rand_number(1, 100) >= 70 && !IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                        if (GET_LIMBCOND(vict, 4) > 0 && !is_sparring(ch) && rand_number(1, 2) == 2) {
                            act("@RYour attack severes $N's left leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@R$n's attack severes your left leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@R$N's left leg is severed in the attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                            GET_LIMBCOND(vict, 4) = 0;
                            remove_limb(vict, 4);
                        } else if (GET_LIMBCOND(vict, 3) > 0 && !is_sparring(ch)) {
                            act("@RYour attack severes $N's right leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@R$n's attack severes your right leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@R$N's right leg is severed in the attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                            GET_LIMBCOND(vict, 3) = 0;
                            remove_limb(vict, 3);
                        }
                    }
        ...
        dmg = damtype(ch, 25, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kienzan at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a kienzan at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Rogafufuken before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Rogafufuken before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Rogafufuken before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your rogafufuken with a punch of $s own!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W rogafufuken with a punch of your own!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W rogafufuken with a punch of $s own!@n", 0, ch, 0, vict,
                        TO_NOTVICT);
                    ...
                    act("@C$N@W moves quickly and blocks your rogafufuken!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W rogafufuken!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W rogafufuken!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your rogafufuken!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W rogafufuken!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W rogafufuken!@n", 0, ch, 0, vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your rogafufuken misses!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a rogafufuken at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a rogafufuken at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
            ...
            if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD) &&
                ...
                act("@c$N's@W fireshield burns your hands and feet!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n's@W hands and feet are burned by your fireshield!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n's@W hands and feet are burned by @C$N's@W fireshield!@n", 1, ch, 0, vict, TO_NOTVICT);
        ...
        dmg = damtype(ch, 23, skill, attperc);
        dmg /= 10;
        act("@WYou fire a rogafufuken at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a rogafufuken at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Dualbeam before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Dualbeam before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Dualbeam before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        while (hits > 0) {
            ...
            if (prob < perc - 20) {
                if (GET_MOVE(vict) > 0) {
                    if (blk > axion_dice(10)) {
                        act("@C$N@W moves quickly and blocks your dualbeam!@n", 0, ch, 0, vict, TO_CHAR);
                        act("@WYou move quickly and block @C$n's@W dualbeam!@n", 0, ch, 0, vict, TO_VICT);
                        act("@C$N@W moves quickly and blocks @c$n's@W dualbeam!@n", 0, ch, 0, vict, TO_NOTVICT);
                        if (hits == 1) {
                            pcost(ch, attperc, 0);
                        }
                        pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                        ...
                        act("@C$N@W manages to dodge your dualbeam, letting it slam into the surroundings!@n", 0,
                            ch, 0, vict, TO_CHAR);
                        act("@WYou dodge @C$n's@W dualbeam, letting it slam into the surroundings!@n", 0, ch, 0,
                            vict, TO_VICT);
                        ...
                        act("@WYou can't believe it but your dualbeam misses, flying through the air harmlessly!@n",
                            0, ch, 0, vict, TO_CHAR);
                        act("@C$n@W fires a dualbeam at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                        act("@c$n@W fires a dualbeam at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                            TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your dualbeam misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a dualbeam at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a dualbeam at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (hits == 1) {
                        pcost(ch, attperc, 0);
                    }
        ...
        dmg = damtype(ch, 22, skill, attperc);
        dmg /= 10;
        act("@WYou fire a dualbeam at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a dualbeam at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@C before reappearing!@n",
                    0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@C before reappearing!@n",
                    0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@C before reappearing!@n",
                    0, ch, 0, vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@n!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@n!@n", 0,
                        ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@n!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@WYou can't believe it but your @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@W misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@W at you, but misses!@n ", 0, ch,
                        0, vict, TO_VICT);
                ...
                act("@WYou can't believe it but your @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@W misses, flying through the air harmlessly!@n",
                    0, ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@W at you, but misses!@n", 0, ch, 0,
                    vict, TO_VICT);
                act("@c$n@W fires a @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr@W at @C$N@W, but somehow misses!@n", 0,
                    ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 42, skill, attperc);
        dmg /= 10;
        act("@WYou fire a @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your kousengan before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c kousengan before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c kousengan before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your kousengan!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W kousengan!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W kousengan!@n", 0, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 42, skill, attperc);
                    dmg /= 4;
                    ...
                    act("@C$N@W manages to dodge your kousengan, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kousengan, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W kousengan, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your kousengan misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a kousengan at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a kousengan at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your kousengan misses, flying through the air harmlessly!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a kousengan at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a kousengan at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 42, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kousengan at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a kousengan at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Deathbeam before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Deathbeam before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Deathbeam before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your deathbeam!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W deathbeam!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W deathbeam!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_DEATHBEAM) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your deathbeam, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W deathbeam, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W deathbeam, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your deathbeam misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a deathbeam at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a deathbeam at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_DEATHBEAM) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                ...
                act("@WYou can't believe it but your deathbeam misses, flying through the air harmlessly!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a deathbeam at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a deathbeam at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_DEATHBEAM) == 3 && attperc > minimum) {
        ...
        dmg = damtype(ch, 17, skill, attperc);
        dmg /= 10;
        act("@WYou fire a deathbeam at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a deathbeam at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
        if (GET_SKILL_PERF(ch, SKILL_DEATHBEAM) == 3) {
            WAIT_STATE(ch, PULSE_3SEC);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Dodonpa before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Dodonpa before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Dodonpa before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your dodonpa!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W dodonpa!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W dodonpa!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_DODONPA) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your dodonpa, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W dodonpa, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W dodonpa, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your dodonpa misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a dodonpa at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a dodonpa at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_DODONPA) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                ...
                act("@WYou can't believe it but your dodonpa misses, flying through the air harmlessly!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a dodonpa at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a dodonpa at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_DODONPA) == 3 && attperc > minimum) {
        ...
        dmg = damtype(ch, 15, skill, attperc);
        dmg /= 10;
        act("@WYou fire a dodonpa at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a dodonpa at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Masenko before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Masenko before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Masenko before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W moves quickly and blocks your masenko!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W masenko!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W masenko!@n", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_MASENKO) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your masenko, letting it slam into the surroundings!@n", 0, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W masenko, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W masenko, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your masenko misses, flying through the air harmlessly!@n", 0,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a masenko at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a masenko at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_MASENKO) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                ...
                act("@WYou can't believe it but your masenko misses, flying through the air harmlessly!@n", 0, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a masenko at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a masenko at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_MASENKO) == 3 && attperc > minimum) {
        ...
        dmg = damtype(ch, 14, skill, attperc);
        dmg /= 10;
        act("@WYou fire a masenko at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a masenko at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Kamehameha Wave before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Kamehameha Wave before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Kamehameha Wave before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W moves quickly and blocks your kamehameha!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W kamehameha!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W kamehameha!@n", 0, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    if (GET_SKILL_PERF(ch, SKILL_KAMEHAMEHA) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                    ...
                    act("@C$N@W manages to dodge your kamehameha, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kamehameha, letting it slam into the surroundings!@n", 0, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W kamehameha, letting it slam into the surroundings!@n", 0,
                        ch, 0, vict, TO_NOTVICT);
                    send_to_room(IN_ROOM(vict), "@wA bright explosion erupts from the impact!\r\n");
                    ...
                    act("@WYou can't believe it but your kamehameha misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a kamehameha at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a kamehameha at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_KAMEHAMEHA) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                ...
                act("@WYou can't believe it but your kamehameha misses, flying through the air harmlessly!@n", 0,
                    ch, 0, vict, TO_CHAR);
                act("@C$n@W fires a kamehameha at you, but misses!@n", 0, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a kamehameha at @C$N@W, but somehow misses!@n", 0, ch, 0, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_KAMEHAMEHA) == 3 && attperc > minimum) {
        ...
        dmg = damtype(ch, 13, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kamehameha at $p@W!@n", 0, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a kamehameha at $p@W!@n", 0, ch, obj, 0, TO_ROOM);
        if (GET_SKILL_PERF(ch, SKILL_KAMEHAMEHA) == 3) {
            WAIT_STATE(ch, PULSE_3SEC);
        }
        hurt(0, 0, ch, NULL, obj, dmg, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Renzokou Energy Dan before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Renzokou Energy Dan before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Renzokou Energy Dan before reappearing!@n", 0, ch, 0,
                    vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (count == 0) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W deflects every shot of your renzokou energy dan, sending them flying away!@n", 1, ch,
                        0, vict, TO_CHAR);
                    act("@WYou deflect every shot @C$n's@W renzokou energy dan sending them flying away!@n", 1, ch,
                        0, vict, TO_VICT);
                    act("@C$N@W deflects every shot of @c$n's@W renzokou energy dan sending them flying away!@n", 1,
                        ch, 0, vict, TO_NOTVICT);
                    if (master_pass == 1)
                        pcost(ch, attperc * 0.25, 0);
                    else if (master_pass == 2)
                    ...
                    act("@C$N@W moves quickly and blocks every renzokou energy dan shot with $S arms!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W renzokou energy dan!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W renzokou energy dan with $S arms!@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                    if (master_pass == 1)
                        pcost(ch, attperc * 0.25, 0);
                    else if (master_pass == 2)
                    ...
                    act("@WYou can't believe it but all your renzokou energy dan shots miss, flying through the air harmlessly!@n",
                        1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires hundreds of renzokou energy dan shots at you, but misses!@n ", 1, ch, 0, vict,
                        TO_VICT);
                    act("@c$n@W fires hundreds of renzokou energy dan shots at @C$N@W, but somehow misses!@n ", 1,
                        ch, 0, vict, TO_NOTVICT);
                    if (master_pass == 1)
                        pcost(ch, attperc * 0.25, 0);
                    else if (master_pass == 2)
                ...
                act("@C$n@W fires hundreds of renzokou energy dan shots at you, but misses!@n", 1, ch, 0, vict,
                    TO_VICT);
                act("@c$n@W fires hundreds of renzokou energy dan shots at @C$N@W, but somehow misses!@n", 1, ch, 0,
                    vict, TO_NOTVICT);
                if (master_pass == 1)
                    pcost(ch, attperc * 0.25, 0);
                else if (master_pass == 2)
        ...
        dmg = damtype(ch, 12, skill, attperc);
        dmg /= 10;
        act("@WYou fire hundreds of renzokou energy dan shots at $p@W!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires hundreds of renzokou energy dan shots at $p@W!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Heeldrop before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Heeldrop before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Heeldrop before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your heeldrop with a punch of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W heeldrop with a punch of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W heeldrop with a punch of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W moves quickly and blocks your heeldrop!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W heeldrop!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W heeldrop!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your heeldrop!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W heeldrop!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W heeldrop!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    ...
                    act("@WYou can't believe it but your heeldrop misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W moves to heeldrop you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W moves to heeldrop @C$N@W, but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou disappear, appearing above @C$N@W you spin and heeldrop $M in the face!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    ...
                    if (AFF_FLAGGED(vict, AFF_FLYING)) {
                        act("@w$N@w is knocked out of the air!@n", 1, ch, 0, vict, TO_CHAR);
                        act("@wYou are knocked out of the air!@n", 1, ch, 0, vict, TO_VICT);
                        act("@w$N@w is knocked out of the air!@n", 1, ch, 0, vict, TO_NOTVICT);
                        REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_FLYING);
                        GET_ALT(vict) = 0;
                ...
                case 2: /* Critical */
                    ...
                    break;
                case 3:
                    act("@WYou fly at @C$N@W, heeldropping $S gut as you fly!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W flies at you, heeldropping your gut as $e flies!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W flies at @C$N@W, heeldropping $S gut as $e flies!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou heeldrop @C$N@W, hitting $M in the arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W heeldrops you, hitting you in the arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W heeldrops @C$N@W, hitting $M in the arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@WYou heeldrop @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W heeldrops your leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W heeldrops @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
            ...
            if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD) &&
                !GET_BONUS(ch, BONUS_FIREPROOF) && !IS_DEMON(ch)) {
                act("@c$N's@W fireshield burns your leg!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n's@W leg is burned by your fireshield!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n's@W leg is burned by @C$N's@W fireshield!@n", 1, ch, 0, vict, TO_NOTVICT);
        ...
        act("@WYou heeldrop $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W heeldrops $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_attack) {
    int prob, perc, avo, index = 0, pry = 0, dge = 0, blk = 0, skill = 0, wtype = 0, gun = 0, gun2 = 0;
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your attack before reappearing!@n", 0, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c attack before reappearing!@n", 0, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c attack before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                if ((wielded == 2 && gun == 0) || (gun2 == 0 && gun == 0))
                    pcost(ch, 0, stcost / 3);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W intercepts and parries your attack with $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou intercept and parry @C$n's@W attack with one of your own!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W intercepts and parries @c$n's@W attack with one of $S own!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (wtype != 4)
                    ...
                    act("@C$N@W moves quickly and blocks your attack!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W attack!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    if ((wielded == 2 && gun == 0) || (gun2 == 0 && gun == 0))
                        pcost(ch, 0, stcost);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your attack!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W attack!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    if ((wielded == 2 && gun == 0) || (gun2 == 0 && gun == 0))
                        pcost(ch, 0, stcost);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your attack misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W moves to attack you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W moves to attack @C$N@W, but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if ((wielded == 2 && gun == 0) || (gun2 == 0 && gun == 0))
                        pcost(ch, 0, stcost / 3);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            if (!IS_NPC(ch)) {
                if (PLR_FLAGGED(ch, PLR_THANDW) && gun == 0 && gun2 == 0) {
            ...
            if (PLR_FLAGGED(ch, PLR_THANDW) && gun == 1) {
            ...
            switch (wtype) {
                case 0:
                    switch (hitspot) {
                        case 1:
                            act("@WYou slash @C$N@W across the stomach!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W slashes you across the stomach!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the stomach!@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou slash @C$N@W across the arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W slashes you across the arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou slash @C$N@W across the leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W slashes you across the leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou slash @C$N@W across the face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W slashes you across the face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            if (!IS_NPC(ch)) {
                                if (PLR_FLAGGED(ch, PLR_THANDW) && gun == 0 && gun2 == 0) {
                                    if (GET_SKILL_BASE(ch, SKILL_TWOHAND) >= 100) {
                            ...
                            break;
                        case 5:
                            act("@WYou slash @C$N@W across the chest!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W slashes you across the chest!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the chest!@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                ...
                case 1:
                    if (!FIGHTING(ch) && backstab(ch, vict, wlvl, dmg)) {
                        if (vict != NULL && GET_HIT(vict) > 1 && axion_dice(0) < (GET_SKILL(ch, SKILL_DUALWIELD)) &&
                    ...
                    switch (hitspot) {
                        case 1:
                            act("@WYou pierce @C$N's@W stomach!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W pierces your stomach!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W stomach!@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou pierce @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W pierces your arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou pierce @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W pierces your leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou pierce @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W pierces your face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 5:
                            act("@WYou pierce @C$N's@W chest!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W pierces your chest!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W chest!@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                ...
                case 2:
                    switch (hitspot) {
                        case 1:
                            act("@WYou crush @C$N's@W chest!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W crushes your chest!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W crushes @C$N's@W chest@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou crush @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W crushes your arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W crushes @C$N's@W arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou crush @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W crushes your leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W crushes @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou crush @C$N@W in the face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W crushes you in the face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W crushes @C$N@W in the face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 5:
                            act("@WYou crush @C$N's@W stomach!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W crushes your stomach!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W crushes @C$N's@W stomach@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                ...
                case 3:
                    switch (hitspot) {
                        case 1:
                            act("@WYou stab @C$N's@W chest!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W stabs your chest!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W stabs @C$N's@W chest!@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou stab @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W stabs your arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W stabs @C$N's@W arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou stab @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W stabs your leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W stabs @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou stab @C$N@W in the face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W stabs you in the face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W stabs @C$N@W in the face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 5:
                            act("@WYou stab @C$N's@W stomach!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W stabs your stomach!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W stabs @C$N's@W stomach@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                ...
                case 4:
                    switch (hitspot) {
                        case 1:
                            act("@WYou blast @C$N's@W chest!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W blasts your chest!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W blasts @C$N's@W chest!@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou blast @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W blasts your arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W blasts @C$N's@W arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou blast @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W blasts your leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W blasts @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou blast @C$N@W in the face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W blasts you in the face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W blasts @C$N@W in the face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 5:
                            act("@WYou blast @C$N's@W stomach!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W blasts your stomach!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W blasts @C$N's@W stomach@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                ...
                case 5:
                    switch (hitspot) {
                        case 1:
                            act("@WYou whack @C$N's@W chest!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W whacks your chest!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W whacks @C$N's@W chest!@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou whack @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W whacks your arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W whacks @C$N's@W arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou whack @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W whacks your leg!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W whacks @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou whack @C$N@W in the face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W whacks you in the face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W whacks @C$N@W in the face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            if (GET_SKILL(ch, SKILL_BRAWL) >= 100) {
                                double mult = calc_critical(ch, 0);
                                mult += 1.0;
                                dmg *= mult;
                            ...
                            break;
                        case 5:
                            act("@WYou whack @C$N's@W stomach!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W whacks your stomach!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W whacks @C$N's@W stomach@n", 1, ch, 0, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
        ...
        if ((wielded == 2 && gun == 0) || (gun2 == 0 && gun == 0)) {
            if (GET_EQ(ch, WEAR_WIELD1)) {
                if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD) &&
                    !GET_BONUS(ch, BONUS_FIREPROOF) && !IS_DEMON(ch)) {
                    act("@c$N's@W fireshield burns your weapon!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n's@W weapon is burned by your fireshield!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n's@W weapon is burned by @C$N's@W fireshield!@n", 1, ch, 0, vict, TO_NOTVICT);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou attack $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W attacks $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        if ((wielded == 2 && gun == 0) || (gun2 == 0 && gun == 0))
            pcost(ch, 0, stcost);
...
ACMD(do_shogekiha) {
    ...
    if (vict) {
        ...
        int master_roll = rand_number(1, 100), master_chance = 0, master_pass = 0;
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Shogekiha before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Shogekiha before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Shogekiha before reappearing!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks shogekiha!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W shogekiha!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W shogekiha!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your shogekiha, letting it slam into the surroundings!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W shogekiha, letting it slam into the surroundings!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W shogekiha, letting it slam into the surroundings!@n", 1,
                        ch, 0, vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your shogekiha misses, flying through the air harmlessly!@n", 1,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W aims $s hand and releases a shogekiha at you, but misses!@n ", 1, ch, 0, vict,
                        TO_VICT);
                    act("@c$n@W aims $s hand and releases a shogekiha at @C$N@W, but somehow misses!@n ", 1, ch, 0,
                        vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your shogekiha misses, flying through the air harmlessly!@n", 1, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W aims $s hand and releases a shogekiha at you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n@W aims $s hand and releases a shogekiha at @C$N@W, but somehow misses!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                pcost(ch, attperc, 0);
            ...
            if (master_pass == 1) {
                act("@CYour skillful shogekiha disipated some of @c$N's@C charged ki!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n@C's skillful shogekiha disipated some of YOUR charged ki!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$n@C's skillful shogekiha disipated some of @c$N's@C charged ki!", 1, ch, 0, vict,
                    TO_NOTVICT);
        ...
        if (KICHARGE(obj) > 0 && GET_CHARGE(ch) > KICHARGE(obj)) {
            ...
            dmg = damtype(ch, 10, skill, attperc);
            dmg /= 10;
            act("@WYou fire a shogekiha at $p@W!@n", 1, ch, obj, 0, TO_CHAR);
            act("@C$n@W fires a shogekiha at $p@W!@n", 1, ch, obj, 0, TO_ROOM);
            hurt(0, 0, ch, NULL, obj, dmg, 0);
            pcost(ch, attperc, 0);
        }
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Tsuihidan before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Tsuihidan before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Tsuihidan before reappearing!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W deflects your tsuihidan, sending it flying away!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou deflect @C$n's@W tsuihidan sending it flying away!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W deflects @c$n's@W tsuihidan sending it flying away!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks tsuihidan!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W tsuihidan!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W tsuihidan!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your tsuihidan, letting it slam into the surroundings!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W tsuihidan, letting it slam into the surroundings!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W tsuihidan, letting it slam into the surroundings!@n", 1,
                        ch, 0, vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your tsuihidan misses, flying through the air harmlessly!@n", 1,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a tsuihidan at you, but misses!@n ", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a tsuihidan at @C$N@W, but somehow misses!@n ", 1, ch, 0, vict, TO_NOTVICT);
                ...
                act("@WYou can't believe it but your tsuihidan misses, flying through the air harmlessly!@n", 1, ch,
                    0, vict, TO_CHAR);
                act("@C$n@W fires a tsuihidan at you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a tsuihidan at @C$N@W, but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                dodge_ki(ch, vict, 1, 11, skill, SKILL_TSUIHIDAN); /* Effects on the room from dodging a ki attack
            ...
            if (master_pass == 1) {
                ...
                if (GET_MOVE(vict) < 0)
                    GET_MOVE(vict) = 0;
                act("@CYour tsuihidan hits a vital spot and seems to sap some of @c$N's@C stamina!@n", 1, ch, 0,
                    vict, TO_CHAR);
                act("@C$n's@C tsuihidan hits a vital spot and saps some of your stamina!@n", 1, ch, 0, vict,
                    TO_VICT);
                act("@C$n's@C tsuihidan hits a vital spot and saps some of @c$N's@C stamina!", 1, ch, 0, vict,
                    TO_NOTVICT);
            }
            pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 11, skill, attperc);
        dmg /= 10;
        act("@WYou fire a tsuihidan at $p@W!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a tsuihidan at $p@W!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_attack2) {
    int prob, perc, avo, index = 0, pry = 0, dge = 0, blk = 0, skill = 0, wtype = 0, gun2 = 0;
    int dualwield = 0;
    int64_t dmg;
    struct char_data *vict = NULL;
    struct obj_data *obj = NULL;
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your attack before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c attack before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c attack before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                ...
                case 1:
                    ...
                    switch (hitspot) {
                        ...
                        case 2:
                            act("@WYou pierce @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W pierces your arm!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W pierces @C$N'@W arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 2:
                    switch (hitspot) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            act("@WYou crush @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W crushes your face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W crushes @C$N'@W face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 3:
                    switch (hitspot) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            act("@WYou stab @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W stabs your face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W stabs @C$N'@W face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 4:
                    switch (hitspot) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            act("@WYou blast @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W blasts your face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W blasts @C$N'@W face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 5:
                    switch (hitspot) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            act("@WYou whack @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                            act("@c$n@W whacks your face!@n", 1, ch, 0, vict, TO_VICT);
                            act("@c$n@W whacks @C$N'@W face!@n", 1, ch, 0, vict, TO_NOTVICT);
                            if (GET_SKILL(ch, SKILL_BRAWL) >= 100) {
                                double mult = calc_critical(ch, 0);
                                mult += 1.0;
                                dmg *= mult;
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your bite before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c bite before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c bite before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                ...
                act("@C$N@c disappears, trying to avoid your bite, but your zanzoken is faster!@n", 1, ch, 0, vict,
                    TO_CHAR);
                act("@cYou zanzoken to avoid the attack but @C$n's@c zanzoken is faster!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, trying to avoid @C$n's@c attack but @C$n's@c zanzoken is faster!@n", 0, ch,
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your bite with a punch of their own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W bite with a punch of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W bite with a punch of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W moves quickly and blocks your bite!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W bite!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W bite!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your bite!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W bite!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W bite!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou move to bite @C$N@W, but miss!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W moves to bite you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W moves to bite @C$N@W, but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou bite @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W bites your face!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W bites into $N's face!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou bite @C$N@W!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W bites you!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W bites @c$N@W!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 4);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou bite @C$N's@W body!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W bites you on the body, sending blood flying!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W bites @c$N@W on the body, sending blood flying!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou bite @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W bites you on the arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W bites @c$N@W on the arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak 2 */
                    act("@WYou bite @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W bites into your leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W bites into @c$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
            ...
            if (!IS_NPC(ch)) {
                if (axion_dice(0) > GET_CON(vict) && rand_number(1, 5) == 5) {
                    act("@R$N@r was poisoned by your bite!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYou were poisoned by the bite!@n", 1, ch, 0, vict, TO_VICT);
                    vict->poisonby = ch;
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@C$n@W bites $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_kiball) {
    int prob, perc, avo, index = 0, pry = 2, dge = 2, blk = 2, skill = 0, frompool = 0;
    int64_t dmg;
    double attperc = .05, minimum = .01;
    struct char_data *vict;
    struct obj_data *obj;
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your kiball before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c kiball before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c kiball before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W deflects your kiball, sending it flying away!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou deflect @C$n's@W kiball sending it flying away!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W deflects @c$n's@W kiball sending it flying away!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks kiball!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W kiball!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W kiball!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your kiball, letting it slam into the surroundings!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kiball, letting it slam into the surroundings!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W kiball, letting it slam into the surroundings!@n", 1, ch,
                        0, vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your kiball misses, flying through the air harmlessly!@n", 1, ch,
                        0, vict, TO_CHAR);
                    act("@C$n@W fires a bright yellow kiball at you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a bright yellow kiball at @C$N@W, but somehow misses!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                ...
                act("@WYou can't believe it but your kiball misses, flying through the air harmlessly!@n", 1, ch, 0,
                    vict, TO_CHAR);
                act("@C$n@W fires a bright yellow kiball at you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a bright yellow kiball at @C$N@W, but somehow misses!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
            ...
            if (mult_count > 1) {
                act("@CYour expertise has allowed you to fire multiple shots in a row!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n's@C expertise has allowed $m to fire multiple shots in a row!@n", 1, ch, 0, vict, TO_ROOM);
            }
            while (mult_count > 0) {
                mult_count -= 1;
                dmg = damtype(ch, 7, skill, attperc);
        ...
        dmg = damtype(ch, 7, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kiball at $p@W!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a kiball at $p@W!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your beam before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c beam before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c beam before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W deflects your beam, sending it flying away!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou deflect @C$n's@W beam sending it flying away!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W deflects @c$n's@W beam sending it flying away!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks beam!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W beam!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W beam!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 10, skill, attperc);
                    ...
                    act("@C$N@W manages to dodge your beam, letting it slam into the surroundings!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W beam, letting it slam into the surroundings!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W beam, letting it slam into the surroundings!@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your beam misses, flying through the air harmlessly!@n", 1, ch,
                        0, vict, TO_CHAR);
                    act("@C$n@W fires a bright yellow beam at you, but misses!@n ", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a bright yellow beam at @C$N@W, but somehow misses!@n ", 1, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                ...
                act("@WYou can't believe it but your beam misses, flying through the air harmlessly!@n", 1, ch, 0,
                    vict, TO_CHAR);
                act("@C$n@W fires a bright yellow beam at you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a bright yellow beam at @C$N@W, but somehow misses!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
            ...
            if (GET_HIT(vict) > 0 && dmg > GET_MAX_HIT(vict) / 4 && master_pass == 1) {
                ...
                if (CAN_GO(vict, attempt)) {
                    act("$N@W is pushed away by the blast!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou are pushed away by the blast!@n", 1, ch, 0, vict, TO_VICT);
                    act("$N@W is pushed away by the blast!@n", 1, ch, 0, vict, TO_NOTVICT);
                    do_simple_move(vict, attempt, 1);
                } else {
                    act("$N@W is pushed away by the blast, but is slammed into an obstruction!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@WYou are pushed away by the blast, but are slammed into an obstruction!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("$N@W is pushed away by the blast, but is slammed into an obstruction!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    dmg *= 2;
        ...
        dmg = damtype(ch, 10, skill, attperc);
        dmg /= 10;
        act("@WYou fire a beam at $p@W!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a beam at $p@W!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_kiblast) {
    ...
    if (vict) {
        ...
        int mastery = rand_number(1, 100), master_pass = 0, chance = 0;
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your kiblast before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c kiblast before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c kiblast before reappearing!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (IS_ANDROID(vict) && HAS_ARMS(vict) && GET_SKILL(vict, SKILL_ABSORB) > rand_number(1, 140)) {
                    ...
                    act("@C$N@W deflects your kiblast, sending it flying away!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou deflect @C$n's@W kiblast sending it flying away!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W deflects @c$n's@W kiblast sending it flying away!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks kiblast!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W kiblast!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W kiblast!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your kiblast, letting it slam into the surroundings!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kiblast, letting it slam into the surroundings!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W kiblast, letting it slam into the surroundings!@n", 1, ch,
                        0, vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your kiblast misses, flying through the air harmlessly!@n", 1,
                        ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a bright yellow kiblast at you, but misses!@n ", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a bright yellow kiblast at @C$N@W, but somehow misses!@n ", 1, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                ...
                act("@WYou can't believe it but your kiblast misses, flying through the air harmlessly!@n", 1, ch, 0,
                    vict, TO_CHAR);
                act("@C$n@W fires a bright yellow kiblast at you, but misses!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n@W fires a bright yellow kiblast at @C$N@W, but somehow misses!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
            ...
            if (master_pass == 1 && record > GET_HIT(vict) && (record - GET_HIT(vict) > gear_pl(vict) * 0.025)) {
                if (!AFF_FLAGGED(vict, AFF_KNOCKED) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                    act("@C$N@W is knocked out!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou are knocked out!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W is knocked out!@n", 1, ch, 0, vict, TO_NOTVICT);
        ...
        dmg = damtype(ch, 10, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kiblast at $p@W!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W fires a kiblast at $p@W!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your slam before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c slam before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c slam before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your slam with a punch of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W slam with a punch of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W slam with a punch of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W moves quickly and blocks your slam!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W slam!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W slam!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 6, skill, attperc);
                    ...
                    act("@C$N@W manages to dodge your slam!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W slam!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W slam!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your slam misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W moves to slam you with both $s fists, but misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W moves to slam @C$N@W with both $s fists, but somehow misses!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou disappear, appearing above @C$N@W and slam a double fisted blow into $M!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@C$n@W disappears, only to appear above you, slamming a double fisted blow into you!@n", 1,
                        ch, 0, vict, TO_VICT);
                ...
                case 2: /* Critical */
                    ...
                    if (ROOM_DAMAGE(IN_ROOM(vict)) <= 95 && !ROOM_FLAGGED(IN_ROOM(vict), ROOM_SPACE)) {
                        act("@W$N@W slams into the ground forming a large crater with $S body!@n", 1, ch, 0, vict,
                            TO_CHAR);
                        act("@WYou slam into the ground forming a large crater with your body!@n", 1, ch, 0, vict,
                            TO_VICT);
                        act("@W$N@W slams into the ground forming a large crater with $S body!@n", 1, ch, 0, vict,
                            TO_NOTVICT);
                        if (SECT(IN_ROOM(vict)) != SECT_INSIDE && SECT(IN_ROOM(vict)) != SECT_UNDERWATER &&
                            ...
                            switch (rand_number(1, 8)) {
                                case 1:
                                    act("Debris is thrown into the air and showers down thunderously!", 1, ch, 0,
                                        vict, TO_CHAR);
                                    act("Debris is thrown into the air and showers down thunderously!", 1, ch, 0,
                                        vict, TO_ROOM);
                                    break;
                                case 2:
                                    if (rand_number(1, 4) == 4 && ROOM_EFFECT(IN_ROOM(vict)) == 0) {
                                        ...
                                        act("Lava leaks up through cracks in the crater!", 1, ch, 0, vict, TO_CHAR);
                                        act("Lava leaks up through cracks in the crater!", 1, ch, 0, vict, TO_ROOM);
                                    }
                                    break;
                                case 3:
                                    act("A cloud of dust envelopes the entire area!", 1, ch, 0, vict, TO_CHAR);
                                    act("A cloud of dust envelopes the entire area!", 1, ch, 0, vict, TO_ROOM);
                                    break;
                                case 4:
                                    act("The surrounding area roars and shudders from the impact!", 1, ch, 0, vict,
                                        TO_CHAR);
                                    act("The surrounding area roars and shudders from the impact!", 1, ch, 0, vict,
                                        TO_ROOM);
                                    break;
                                case 5:
                                    act("The ground shatters apart from the stress of the impact!", 1, ch, 0, vict,
                                        TO_CHAR);
                                    act("The ground shatters apart from the stress of the impact!", 1, ch, 0, vict,
                                        TO_ROOM);
                                    break;
                        ...
                        if (SECT(IN_ROOM(vict)) == SECT_UNDERWATER) {
                            switch (rand_number(1, 3)) {
                                case 1:
                                    act("The water churns violently!", 1, ch, 0, vict, TO_CHAR);
                                    act("The water churns violently!", 1, ch, 0, vict, TO_ROOM);
                                    break;
                                case 2:
                                    act("Large bubbles rise from the movement!", 1, ch, 0, vict, TO_CHAR);
                                    act("Large bubbles rise from the movement!", 1, ch, 0, vict, TO_ROOM);
                                    break;
                                case 3:
                                    act("The water collapses in on the hole created!", 1, ch, 0, vict, TO_CHAR);
                                    act("The water collapses in on the hole create!", 1, ch, 0, vict, TO_ROOM);
                                    break;
                            }
                        }
                        if (SECT(IN_ROOM(vict)) == SECT_WATER_SWIM || SECT(IN_ROOM(vict)) == SECT_WATER_NOSWIM) {
                            switch (rand_number(1, 3)) {
                                case 1:
                                    act("A huge column of water erupts from the impact!", 1, ch, 0, vict, TO_CHAR);
                                    act("A huge column of water erupts from the impact!", 1, ch, 0, vict, TO_ROOM);
                                    break;
                                case 2:
                                    act("The impact briefly causes a swirling vortex of water!", 1, ch, 0, vict,
                                        TO_CHAR);
                                    act("The impact briefly causes a swirling vortex of water!", 1, ch, 0, vict,
                                        TO_ROOM);
                                    break;
                        ...
                        if (SECT(IN_ROOM(vict)) == SECT_INSIDE) {
                            ...
                            switch (rand_number(1, 8)) {
                                ...
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    act("Parts of the ceiling collapse, crushing into the floor!", 1, ch, 0, vict,
                                        TO_CHAR);
                                    act("Parts of the ceiling collapse, crushing into the floor!", 1, ch, 0, vict,
                                        TO_ROOM);
                                    break;
                                ...
                                case 5:
                                    ...
                                    break;
                                case 6:
                                    act("The walls of the surrounding room crack in the same instant!", 1, ch, 0,
                                        vict, TO_CHAR);
                                    act("The walls of the surrounding room crack in the same instant!", 1, ch, 0,
                                        vict, TO_ROOM);
                                    break;
                    ...
                    break;
                case 3:
                    act("@WYou fly at @C$N@W, slamming both your fists into $S gut as you fly!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@C$n@W flies at you, slamming both $s fists into your gut as $e flies!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@c$n@W flies at @C$N@W, slamming both $s fists into $S gut as $e flies!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou slam both your fists into @C$N@W, hitting $M in the arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams both $s fists into you, hitting you in the arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams both $s fists into @C$N@W, hitting $M in the arm!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@WYou slam both your fists into @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams both $s fists into your leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams both $s fists into @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
            ...
            if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD) &&
                !GET_BONUS(ch, BONUS_FIREPROOF) && !IS_DEMON(ch)) {
                act("@c$N's@W fireshield burns your hands!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n's@W hands are burned by your fireshield!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n's@W hands are burned by @C$N's@W fireshield!@n", 1, ch, 0, vict, TO_NOTVICT);
                dmg = GET_MAX_MANA(vict) * 0.02;
                LASTATK(vict) += 1000;
                hurt(0, 0, vict, ch, NULL, dmg, 0);
                if (GET_BONUS(ch, BONUS_FIREPRONE)) {
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou slam $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W slams $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your uppercut before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c uppercut before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c uppercut before reappearing!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your uppercut with a punch of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W uppercut with a punch of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W uppercut with a punch of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W moves quickly and blocks your uppercut!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W uppercut!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W uppercut!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your uppercut!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W uppercut!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W uppercut!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your uppercut misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W throws an uppercut at you but somehow misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W throws an uppercut at @C$N@W but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou leap up and launch an uppercut into @C$N's@W body!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W leaps up and launches an uppercut into your body!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W leaps up and launches an uppercut into @C$N's@W body!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou smash an uppercut into @C$N's@W chin!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W smashes an uppercut into your chin!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W smashes an uppercut into @C$N's@W chin!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (!AFF_FLAGGED(vict, AFF_KNOCKED) &&
                    ...
                    break;
                case 3:
                    act("@WYou uppercut @C$N@W, hitting $M directly in chest!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W uppercuts you, hitting you directly in the chest!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W uppercuts @C$N@W, hitting $M directly in the chest!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYour poorly aimed uppercut hits @C$N@W in the arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W poorly aims an uppercut and hits you in the arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W poorly aims an uppercut and hits @C$N@W in the arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak 2 */
                    act("@WYou slam an uppercut into @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams an uppercut into your leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams an uppercut into @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(1, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
            ...
            if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD) &&
                !GET_BONUS(ch, BONUS_FIREPROOF) && !IS_DEMON(ch)) {
                act("@c$N's@W fireshield burns your hand!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n's@W hand is burned by your fireshield!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n's@W hand is burned by @C$N's@W fireshield!@n", 1, ch, 0, vict, TO_NOTVICT);
                dmg = GET_MAX_MANA(vict) * 0.02;
                LASTATK(vict) += 1000;
                hurt(0, 0, vict, ch, NULL, dmg, 0);
                if (GET_BONUS(ch, BONUS_FIREPRONE)) {
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou uppercut $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W uppercuts $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                ...
                COMBO(ch) -= 1;
                COMBHITS(ch) = 0;
                act("@C$N@c disappears, avoiding your tailwhip before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c tailwhip before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c tailwhip before reappearing!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
                }
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your tailwhip with a punch of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W tailwhip with a punch of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W tailwhip with a punch of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W moves quickly and blocks your tailwhip!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W tailwhip!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W tailwhip!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your tailwhip!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W tailwhip!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W tailwhip!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your tailwhip misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W throws a tailwhip at you but somehow misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W throws a tailwhip at @C$N@W but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou spin to swing your tail and slam it into @c$N@W's body!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W spins to swing $s tail and slams it into YOUR body!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W spins to swing $s tail and slams it into @c$N@W's body!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou flip forward and slam your tail into the top of @c$N@W's head brutally!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@C$n@W flips forward and slams $s tail into the top of YOUR head brutally!@n", 1, ch, 0,
                        vict, TO_VICT);
                    act("@C$n@W flips forward and slams $s tail into the top of @c$N@W's head brutally!@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                    ...
                    break;
                case 3:
                    act("@WYou swing your tail and manage to slam it into @c$N@W's gut!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W swings $s tail and manages to slam it into YOUR gut!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W swings $s tail and manages to slam it into @c$N@W's gut!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (!AFF_FLAGGED(vict, AFF_FLYING) && GET_POS(vict) == POS_STANDING && rand_number(1, 8) >= 7) {
                        handle_knockdown(vict);
                    }
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou swing your tail and manage to slam it into @c$N@W's arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W swings $s tail and manages to slam it into YOUR arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W swings $s tail and manages to slam it into @c$N@W's arm!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@WYou swing your tail and manage to slam it into @c$N@W's leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W swings $s tail and manages to slam it into YOUR leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W swings $s tail and manages to slam it into @c$N@W's leg!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(1, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou tailwhip $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W tailwhips $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_roundhouse) {
    ...
    if (!limb_ok(ch, 1)) {
        ...
        if (GET_LIMBCOND(ch, 3) < 0) {
            act("@RYour right leg has fallen apart!@n", 1, ch, 0, 0, TO_CHAR);
            act("@r$n@R's right leg has fallen apart!@n", 1, ch, 0, 0, TO_ROOM);
        }
        ...
        if (GET_LIMBCOND(ch, 4) < 0) {
            act("@RYour left leg has fallen apart!@n", 1, ch, 0, 0, TO_CHAR);
            act("@r$n@R's left leg has fallen apart!@n", 1, ch, 0, 0, TO_ROOM);
        }
    }
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your roundhouse before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c roundhouse before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c roundhouse before reappearing!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your roundhouse with a punch of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W roundhouse with a punch of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W roundhouse with a punch of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W moves quickly and blocks your roundhouse!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W roundhouse!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W roundhouse!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your roundhouse!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W roundhouse!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W roundhouse!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your roundhouse misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W throws a roundhouse at you but somehow misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W throws a roundhouse at @C$N@W but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou spin in mid air and land a kick into @C$N's@W body!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W spins in mid air and lands a kick into your body!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W spins in mid air and lands a kick into @C$N's@W body!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou spin a fierce roundhouse into @C$N's@W gut!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W spins a fierce roundhouse into your gut!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W spins a fierce roundhouse into @C$N's@W gut!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (!AFF_FLAGGED(vict, AFF_FLYING) && GET_POS(vict) == POS_STANDING && rand_number(1, 8) >= 7) {
                        handle_knockdown(vict);
                    }
                    dmg *= calc_critical(ch, 0);
                    ...
                    break;
                case 3:
                    act("@WYou throw a roundhouse at @C$N@W, hitting $M directly in the neck!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@C$n@W throws a roundhouse at you, hitting YOU directly in the neck!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@c$n@W throws a roundhouse at @C$N@W, hitting $M directly in the face!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYour poorly aimed roundhouse hits @C$N@W in the arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W poorly aims a roundhouse and hits you in the arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W poorly aims a roundhouse and hits @C$N@W in the arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak 2 */
                    act("@WYou slam a roundhouse into @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams a roundhouse into your leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams a roundhouse into @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(1, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou roundhouse $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W roundhouses $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your elbow before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c elbow before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c elbow before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your elbow with an elbow of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W elbow with one of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W elbow with an elbow of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W blocks your elbow strike!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou block @C$n's@W elbow strike!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W elbow strike!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W dodges your elbow strike!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W elbow strike!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W elbow strike!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your elbow strike misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W throws an elbow strike at you, but thankfully misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W throws an elbow strike at @C$N@W, but misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@WYou can't believe it, your elbow strike misses!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n@W throws an elbow stike at you, but thankfully misses!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n@W throws an elbow strike at @C$N@W, but misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your elbow into @C$N's@W body!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams $s elbow into your body!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams $s elbow into @C$N's@W body!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your elbow into @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams $s elbow into your face!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams $s elbow into @C$N's@W face!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou land your elbow against @C$N's@W gut!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W lands $s elbow against your gut!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W lands $s elbow against @C$N's@W gut!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou land your elbow against @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W lands $s elbow against your leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W lands $s elbow against @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak */
                    act("@WYou land your elbow against @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W lands $s elbow against your arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W lands $s elbow against @C$N's@W arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
            ...
            if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD) &&
                !GET_BONUS(ch, BONUS_FIREPROOF) && !IS_DEMON(ch)) {
                act("@c$N's@W fireshield burns your elbow!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n's@W elbow is burned by your fireshield!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n's@W elbow is burned by @C$N's@W fireshield!@n", 1, ch, 0, vict, TO_NOTVICT);
                dmg = GET_MAX_MANA(vict) * 0.02;
                LASTATK(vict) += 1000;
                hurt(0, 0, vict, ch, NULL, dmg, 0);
                if (GET_BONUS(ch, BONUS_FIREPRONE)) {
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou elbow stike $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W elbow strikes $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your kick before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c kick before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c kick before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your kick with a kick of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W kick with one of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W kick with a kick of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W blocks your kick!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou block @C$n's@W kick!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W kick!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 1, skill, attperc);
                    ...
                    act("@C$N@W dodges your kick!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kick!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W kick!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your kick misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W throws a kick at you, but thankfully misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W throws a kick at @C$N@W, but misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your foot into @C$N's@W body!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams $s foot into your body!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams $s foot into @C$N's@W body!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your foot into @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams $s foot into your face!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams $s foot into @C$N's@W face!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou land your foot against @C$N's@W gut!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W lands $s foot against your gut!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W lands $s foot against @C$N's@W gut!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou land your foot against @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W lands $s foot against your leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W lands $s foot against @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak */
                    act("@WYou land your foot against @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W lands $s foot against your arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W lands $s foot against @C$N's@W arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou kick $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W kicks $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your knee strike before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c knee strike before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c knee strike before reappearing!@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your knee with a knee of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W knee with one of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W knee with a knee of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W blocks your knee strike!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou block @C$n's@W knee strike!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W knee strike!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 3, skill, attperc);
                    ...
                    act("@C$N@W dodges your knee strike!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W knee strike!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W knee strike!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your knee strike misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W throws a knee strike at you, but thankfully misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W throws a knee strike at @C$N@W, but misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@WYou can't believe it, your  knee strike misses!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n@W throws a knee stike at you, but thankfully misses!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n@W throws a knee strike at @C$N@W, but misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your knee into @C$N's@W body!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams $s knee into your body!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams $s knee into @C$N's@W body!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your knee into @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams $s knee into your face!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams $s knee into @C$N's@W face!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou land your knee against @C$N's@W gut!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W lands $s knee against your gut!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W lands $s knee against @C$N's@W gut!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou land your knee against @C$N's@W leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W lands $s knee against your leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W lands $s knee against @C$N's@W leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak */
                    act("@WYou land your knee against @C$N's@W arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W lands $s knee against your arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$n@W lands $s knee against @C$N's@W arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
            ...
            if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD) &&
                !GET_BONUS(ch, BONUS_FIREPROOF) && !IS_DEMON(ch)) {
                act("@c$N's@W fireshield burns your knee!@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n's@W knee is burned by your fireshield!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$n's@W knee is burned by @C$N's@W fireshield!@n", 1, ch, 0, vict, TO_NOTVICT);
                dmg = GET_MAX_MANA(vict) * 0.02;
                LASTATK(vict) += 1000;
                hurt(0, 0, vict, ch, NULL, dmg, 0);
                if (GET_BONUS(ch, BONUS_FIREPRONE)) {
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou knee stike $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W knee strikes $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your punch before reappearing!@n", 1, ch, 0, vict, TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c punch before reappearing!@n", 1, ch, 0, vict, TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c punch before reappearing!@n", 1, ch, 0, vict, TO_NOTVICT);
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                if (AFF_FLAGGED(ch, AFF_ZANZOKEN)) {
                    REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_ZANZOKEN);
        ...
        if (prob < perc - 20) {
            if (GET_MOVE(vict) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your punch with a punch of $S own!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W punch with a punch of your own!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W punch with a punch of $S own!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W moves quickly and blocks your punch!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W punch!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W punch!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 0, skill, attperc);
                    ...
                    act("@C$N@W manages to dodge your punch!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W punch!@n", 1, ch, 0, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W punch!@n", 1, ch, 0, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your punch misses!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W throws a punch at you but somehow misses!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W throws a punch at @C$N@W but somehow misses!@n", 1, ch, 0, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your fist into @C$N's@W body!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams $s fist into your body!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams $s fist into @C$N's@W body!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your fist into @C$N's@W face!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W slams $s fist into your face!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W slams $s fist into @C$N's@W face!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou punch @C$N@W directly in the gut!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W punches you directly in the gut!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W punches @C$N@W directly in the gut!@n", 1, ch, 0, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou punch @C$N@W in the arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W punches you in the arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W punches @C$N@W in the arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak 2 */
                    act("@WYou punch @C$N@W in the leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@C$n@W punches you in the leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$n@W punches @C$N@W in the arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou punch $p@W as hard as you can!@n", 1, ch, obj, 0, TO_CHAR);
        act("@C$n@W punches $p@W extremely hard!@n", 1, ch, obj, 0, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_charge) {
    ...
    if (!*arg) {
        ...
        switch (rand_number(1, 3)) {
            case 1:
                act("$n@w's aura disappears.@n", 1, ch, 0, 0, TO_ROOM);
                break;
            case 2:
                act("$n@w's aura fades.@n", 1, ch, 0, 0, TO_ROOM);
                break;
            case 3:
                act("$n@w's aura flickers brightly before disappearing.@n", 1, ch, 0, 0, TO_ROOM);
                break;
            default:
                act("$n@w's aura disappears.@n", 1, ch, 0, 0, TO_ROOM);
                break;
...
ACMD(do_powerup) {
    if (IS_NPC(ch)) {
        ...
        if (GET_MAX_HIT(ch) < 50000) {
            act("@RYou begin to powerup, and air billows outward around you!@n", 1, ch, 0, 0, TO_CHAR);
            act("@R$n begins to powerup, and air billows outward around $m!@n", 1, ch, 0, 0, TO_ROOM);
        } else if (GET_MAX_HIT(ch) < 500000) {
            act("@RYou begin to powerup, and loose objects are lifted into the air!@n", 1, ch, 0, 0, TO_CHAR);
            act("@R$n begins to powerup, and loose objects are lifted into the air!@n", 1, ch, 0, 0, TO_ROOM);
        } else if (GET_MAX_HIT(ch) < 5000000) {
            act("@RYou begin to powerup, and torrents of energy crackle around you!@n", 1, ch, 0, 0, TO_CHAR);
            act("@R$n begins to powerup, and torrents of energy crackle around $m!@n", 1, ch, 0, 0, TO_ROOM);
        } else if (GET_MAX_HIT(ch) < 50000000) {
            act("@RYou begin to powerup, and the entire area begins to shudder!@n", 1, ch, 0, 0, TO_CHAR);
            act("@R$n begins to powerup, and the entire area begins to shudder!@n", 1, ch, 0, 0, TO_ROOM);
        } else if (GET_MAX_HIT(ch) < 100000000) {
            act("@RYou begin to powerup, and massive cracks begin to form beneath you!@n", 1, ch, 0, 0, TO_CHAR);
            act("@R$n begins to powerup, and massive cracks begin to form beneath $m!@n", 1, ch, 0, 0, TO_ROOM);
        } else if (GET_MAX_HIT(ch) < 300000000) {
            act("@RYou begin to powerup, and everything around you shudders from the power!@n", 1, ch, 0, 0,
                TO_CHAR);
            act("@R$n begins to powerup, and everything around $m shudders from the power!@n", 1, ch, 0, 0, TO_ROOM);
        } else {
            act("@RYou begin to powerup, and the very air around you begins to burn!@n", 1, ch, 0, 0, TO_CHAR);
            act("@R$n begins to powerup, and the very air around $m begins to burn!@n", 1, ch, 0, 0, TO_ROOM);
        }
        return;
    }
    if (PLR_FLAGGED(ch, PLR_AURALIGHT)) {
...
ACMD(do_rescue) {
    ...
    if (!*arg)
        ...
        if (GET_SPEEDI(ch) + mobbonus < GET_SPEEDI(opponent) && rand_number(1, 3) != 3) {
            act("@GYou leap towards @g$N@G and try to rescue $M but are too slow!@n", 1, ch, 0, helpee, TO_CHAR);
            act("@g$n@G leaps towards you! $n is too slow and fails to rescue you!@n", 1, ch, 0, helpee, TO_VICT);
            act("@g$n@G leaps towards @g$N@G and tries to rescue $M but is too slow!@n", 1, ch, 0, helpee,
                TO_NOTVICT);
            return;
        }
        act("@GYou leap in front of @g$N@G and rescue $M!@n", 1, ch, 0, helpee, TO_CHAR);
        act("@g$n@G leaps in front of you! You are rescued!@n", 1, ch, 0, helpee, TO_VICT);
        act("@g$n@G leaps in front of @g$N@G and rescues $M!@n", 1, ch, 0, helpee, TO_NOTVICT);
...
ACMD(do_assist) {
     ...
     */
        ...
        if (!opponent)
            act("But nobody is fighting $M!", 1, ch, 0, helpee, TO_CHAR);
        else if (!CAN_SEE(ch, opponent))
            act("You can't see who is fighting $M!", 1, ch, 0, helpee, TO_CHAR);
            /* prevent accidental pkill */
        else {
            reveal_hiding(ch, 0);
            send_to_char(ch, "You join the fight!\r\n");
            act("$N assists you!", 0, helpee, 0, ch, TO_CHAR);
            act("$n assists $N.", 1, ch, 0, helpee, TO_NOTVICT);
            if (!FIGHTING(ch)) {
...
ACMD(do_kill) {
    ...
    if (!*arg) {
        ...
        if (!(vict = get_char_vis(ch, arg, NULL, FIND_CHAR_ROOM)))
            ...
            act("You chop $M to pieces!  Ah!  The blood!", 1, ch, 0, vict, TO_CHAR);
            act("$N chops you to pieces!", 1, vict, 0, ch, TO_CHAR);
            act("$n brutally slays $N!", 1, ch, 0, vict, TO_NOTVICT);
            raw_kill(vict, ch);
        }
    }
}
...
ACMD(do_flee) {
    ...
    for (i = 0; i < 12; i++) {
        if (*arg) {
            if ((attempt = search_block(arg, dirs, 0) > -1)) {
                attempt = search_block(arg, dirs, 0);
            } else if ((attempt = search_block(arg, abbr_dirs, 0) > -1)) {
                attempt = search_block(arg, abbr_dirs, 0);
            } else {
        ...
        if (CAN_GO(ch, attempt) &&
            ...
            if (ABSORBBY(ch)) {
                if (axion_dice(0) < GET_SKILL(ABSORBING(ch), SKILL_ABSORB)) {
                    ...
                    act("@c$N@W manages to break loose of @C$n's@W hold!@n", 1, ABSORBBY(ch), 0, ch, TO_NOTVICT);
                    act("@WYou manage to break loose of @C$n's@W hold!@n", 1, ABSORBBY(ch), 0, ch, TO_VICT);
                    act("@c$N@W manages to break loose of your hold!@n", 1, ABSORBBY(ch), 0, ch, TO_CHAR);
                    ABSORBING(ABSORBBY(ch)) = NULL;
                    ABSORBBY(ch) = NULL;
                }
            }
            if (do_simple_move(ch, attempt, 1)) {
                send_to_char(ch, "You flee head over heels.\r\n");
                WAIT_STATE(ch, PULSE_2SEC);
            } else {
                act("$n tries to flee, but can't!", 1, ch, 0, 0, TO_ROOM);
                WAIT_STATE(ch, PULSE_2SEC);
            }
            return;
        }
