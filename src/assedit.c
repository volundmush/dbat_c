...
/*        free(OLC_ASSEDIT(d)->pComponents); */
        ...
        case ASSEDIT_EDIT_EXTRACT:
            switch (*arg) {
                case 'y':
                case 'Y':
                    OLC_ASSEDIT(d)->pComponents[OLC_VAL(d)].bExtract = 1;
                    assedit_edit_inroom(d);
                    break;

                case 'n':
                case 'N':
                    OLC_ASSEDIT(d)->pComponents[OLC_VAL(d)].bExtract = 0;
                    assedit_edit_inroom(d);
                    break;
        ...
        default:                        /* default for whole assedit parse function */
            ...
            mudlog(BRF, ADMLVL_GOD, 1, "SYSERR: OLC assedit_parse(): Reached default case!");
