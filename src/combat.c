...
void damage_weapon(struct char_data *ch, struct obj_data *obj, struct char_data *vict) {
    ...
    if (GET_SKILL(ch, SKILL_HANDLING) >= axion_dice(10)) {
        act("@GYour superior handling prevents @C$p@G from being damaged.@n", 1, ch, obj, 0, TO_CHAR);
        act("@g$n's@G superior handling prevents @C$p@G from being damaged.@n", 1, ch, obj, 0, TO_ROOM);
        result = 0;
    }
    ...
    if (result > 0) {
        ...
        if (GET_OBJ_VAL(obj, VAL_ALL_HEALTH) <= 0) {
            act("@RYour @C$p@R shatters on @r$N's@R body!@n", 1, ch, obj, vict, TO_CHAR);
            act("@r$n's@R @C$p@R shatters on YOUR body!@n", 1, ch, obj, vict, TO_VICT);
            act("@r$n's@R @C$p@R shatters on @r$N's@R body!@n", 1, ch, obj, vict, TO_NOTVICT);
            SET_BIT_AR(GET_OBJ_EXTRA(obj), ITEM_BROKEN);
            perform_remove(vict, 16);
            perform_remove(vict, 17);
        } else if (result >= 8) {
            act("@RYour @C$p@R cracks loudly from striking @r$N's@R body!@n", 1, ch, obj, vict, TO_CHAR);
            act("@r$n's@R @C$p@R cracks loudly from striking YOUR body!@n", 1, ch, obj, vict, TO_VICT);
            act("@r$n's@R @C$p@R cracks loudly from striking @r$N's@R body!@n", 1, ch, obj, vict, TO_NOTVICT);
        } else if (result >= 6) {
            act("@RYour @C$p@R chips from striking @r$N's@R body!@n", 1, ch, obj, vict, TO_CHAR);
            act("@r$n's@R @C$p@R cracks from striking YOUR body!@n", 1, ch, obj, vict, TO_VICT);
            act("@r$n's@R @C$p@R cracks from striking @r$N's@R body!@n", 1, ch, obj, vict, TO_NOTVICT);
        } else if (result >= 3) {
            act("@RYour @C$p@R loses a piece from striking @r$N's@R body!@n", 1, ch, obj, vict, TO_CHAR);
            act("@r$n's@R @C$p@R loses a piece from striking YOUR body!@n", 1, ch, obj, vict, TO_VICT);
            act("@r$n's@R @C$p@R loses a piece from striking @r$N's@R body!@n", 1, ch, obj, vict, TO_NOTVICT);
        } else if (result >= 6) {
            act("@RYour @C$p@R has a nick in it from hitting @r$N's@R body!@n", 1, ch, obj, vict, TO_CHAR);
            act("@r$n's@R @C$p@R has a nick in it from hitting YOUR body!@n", 1, ch, obj, vict, TO_VICT);
            act("@r$n's@R @C$p@R has a nick in it from hitting @r$N's@R body!@n", 1, ch, obj, vict, TO_NOTVICT);
        }
    }
}
...
void handle_multihit(struct char_data *ch, struct char_data *vict) {
    ...
    if (perc >= prob) {
        ...
        act("@Y...in a lightning flash of speed you attack @y$N@Y again!@n", 1, ch, 0, vict, TO_CHAR);
        act("@Y...in a lightning flash of speed @y$n@Y attacks YOU again!@n", 1, ch, 0, vict, TO_VICT);
        act("@Y...in a lightning flash of speed @y$n@Y attacks @y$N@Y again!@n", 1, ch, 0, vict, TO_NOTVICT);
        ch->throws += 1;
...
int handle_defender(struct char_data *vict, struct char_data *ch) {
    ...
    if (GET_DEFENDER(vict)) {
        ...
        if (GET_SPEEDI(def) + defnum > GET_SPEEDI(ch) + chnum && IN_ROOM(def) == IN_ROOM(vict) &&
            ...
            act("@YYou move to and manage to intercept the attack aimed at @y$N@Y!@n", 1, def, 0, vict, TO_CHAR);
            act("@y$n@Y moves to and manages to intercept the attack aimed at YOU!@n", 1, def, 0, vict, TO_VICT);
            act("@y$n@Y moves to and manages to intercept the attack aimed at @y$N@Y!@n", 1, def, 0, vict,
                TO_NOTVICT);
            result = 1;
        } else if (IN_ROOM(def) == IN_ROOM(vict) && GET_POS(def) > POS_SITTING) {
            act("@YYou move to intercept the attack aimed at @y$N@Y, but just not fast enough!@n", 1, def, 0, vict,
                TO_CHAR);
            act("@y$n@Y moves to intercept the attack aimed at YOU, but $e wasn't fast enough!@n", 1, def, 0, vict,
                TO_VICT);
            act("@y$n@Y moves to intercept the attack aimed at @y$N@Y, but $e wasn't fast enough!@n", 1, def, 0,
                vict, TO_NOTVICT);
        }
    }
...
void handle_disarm(struct char_data *ch, struct char_data *vict) {
    ...
    int roll1 = rand_number(-10, 10), roll2 = rand_number(-10, 10), handled = 0;
    ...
    if (roll1 < roll2) {
        struct obj_data *obj;
        if (GET_EQ(ch, WEAR_WIELD1) && handled == 0) {
            obj = GET_EQ(ch, WEAR_WIELD1);
            act("@y$N@Y manages to disarm you! The @w$p@Y falls from your grasp!@n", 1, ch, obj, vict, TO_CHAR);
            act("@y$N@Y manages to disarm @R$n@Y! The @w$p@Y falls from $s grasp!@n", 1, ch, obj, vict, TO_NOTVICT);
            act("@YYou manage to disarm @R$n@Y! The @w$p@Y falls from $s grasp!@n", 1, ch, obj, vict, TO_VICT);
            perform_remove(ch, 16);
            if (GET_OBJ_VNUM(obj) != 20098) {
                obj_from_char(obj);
                obj_to_room(obj, IN_ROOM(ch));
            }
        } else if (GET_EQ(ch, WEAR_WIELD1) && handled == 1) {
            obj = GET_EQ(ch, WEAR_WIELD1);
            act("@y$N@Y almosts disarms you, but your handling of @w$p@Y saves it from slipping from your grasp!@n",
                1, ch, obj, vict, TO_CHAR);
            act("@y$N@Y almost disarms @R$n@Y, but $s handling of @w$p@Y saves it from slipping from $s grasp!@n", 1,
                ch, obj, vict, TO_NOTVICT);
            act("@YYou almost disarm @R$n@Y, but $s handling of @w$p@Y saves it from slipping from $s grasp!@n", 1,
                ch, obj, vict, TO_VICT);
        } else if (GET_EQ(ch, WEAR_WIELD2) && handled == 1) {
...
void combine_attacks(struct char_data *ch, struct char_data *vict) {
    ...
    double maxki = 0.0;
    int totalmem = 1;
    int attspd = 0, blockable = 1, same = 1, attsk = 0, attavg = GET_SKILL(ch, attack_skills[GET_COMBINE(ch)]);
    int burn = 0, shocked = 0;
    ...
    act(chbuf, 1, ch, 0, vict, TO_CHAR);
    act(victbuf, 1, ch, 0, vict, TO_VICT);
    act(rmbuf, 1, ch, 0, vict, TO_NOTVICT);
    ...
    for (f = ch->followers; f; f = f->next) {
        if (!AFF_FLAGGED(f->follower, AFF_GROUP)) {
            ...
            sprintf(folbuf2, "@WYou time and merge your @B'@R%s@B'@W into the group attack!@n",
                    attack_names_comp[GET_COMBINE(f->follower)]);
            act(folbuf, 1, f->follower, 0, 0, TO_ROOM);
            act(folbuf2, 1, f->follower, 0, 0, TO_CHAR);
        }
    }
    ...
    if (GET_COMBINE(ch) != 5) {
        if (attspd + attsk < GET_SKILL(vict, SKILL_DODGE) + (GET_CHA(ch) / 10)) {
            act("@GYou manage to dodge nimbly through the combined attack of your enemies!@n", 1, vict, 0, 0,
                TO_CHAR);
            act("@r$n@G manages to dodge nimbly through the combined attack!@n", 1, vict, 0, 0, TO_ROOM);
            return;
        } else if (blockable == 1 && attspd + attsk < GET_SKILL(vict, SKILL_BLOCK) + (GET_STR(ch) / 10)) {
...
static bool is_hot_ruby(struct obj_data *obj) {
    return GET_OBJ_VNUM(obj) == 6600 && OBJ_FLAGGED(obj, ITEM_HOT);
}

bool check_ruby(struct char_data *ch) {
    struct obj_data *ruby = find_obj_in_list_lambda(ch->carrying, &is_hot_ruby);

    if (ruby) {
        act("@RYour $p@R flares up and disappears. Your fire attack has been aided!@n", 1, ch, ruby, 0, TO_CHAR);
        act("@R$n's@R $p@R flares up and disappears!@n", 1, ch, ruby, 0, TO_ROOM);
        extract_obj(ruby);
        return true;
    } else {
        return false;
...
void handle_knockdown(struct char_data *ch) {
    ...
    if (chance > axion_dice(0)) {
        act("@mYou are @GALMOST@m knocked off your feet, but your great balance helps you keep your footing!@n", 1,
            ch, 0, 0, TO_CHAR);
        act("@W$n@m is @GALMOST@m knocked off $s feet, but $s great balance helps $m keep $s footing!@n", 1, ch, 0,
            0, TO_ROOM);
    } else {
        act("@mYou are knocked off your feet!@n", 1, ch, 0, 0, TO_CHAR);
        act("@W$n@m is knocked off $s feet!@n", 1, ch, 0, 0, TO_ROOM);
        GET_POS(ch) = POS_SITTING;
    }

}

bool boom_headshot(struct char_data *ch) {
...
bool backstab(struct char_data *ch, struct char_data *vict, int wlvl, int64_t dmg) {
    ...
    if (chance >= roll_to_beat) {
        ...
        if (attacker_roll > defender_roll) {
            act("@RYou manage to sneak behind @r$N@R and stab $M in the back!@n", 1, ch, 0, vict, TO_CHAR);
            act("@RYou feel @r$n's@R dagger thrust into your back unexpectantly!@n", 1, ch, 0, vict, TO_VICT);
            act("@r$n@R sneaks up behind @r$N@R and stabs $M in the back!@n", 1, ch, 0, vict, TO_NOTVICT);
            dmg += dmg * bonus;
...
void cut_limb(struct char_data *ch, struct char_data *vict, int wlvl, int hitspot) {
    ...
    int chance = 0, decap = 0, decapitate = 0;
    ...
    if (decapitate == 1) {
        act("@R$N's@r head is cut off in the attack!@n", 1, ch, 0, vict, TO_CHAR);
        act("@RYOUR head is cut off in the attack!@n", 1, ch, 0, vict, TO_VICT);
        act("@R$N's@rhead is cut off in the attack!@n", 1, ch, 0, vict, TO_NOTVICT);
        ...
        if (!IS_NPC(vict)) {
            if (HAS_ARMS(vict) && rand_number(1, 2) == 2) {
                if (GET_LIMBCOND(vict, 2) > 0) {
                    ...
                    act("@R$N@r loses $s left arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@RYOU lose your left arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r loses $s left arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    remove_limb(vict, 2);
                    ...
                    act("@R$N@r loses $s right arm!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@RYOU lose your right arm!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r loses $s right arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                    remove_limb(vict, 1);
                }
            } else { /* It's a leg */
                if (GET_LIMBCOND(vict, 4) > 0) {
                    ...
                    act("@R$N@r loses $s left leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@RYOU lose your left leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r loses $s left leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    remove_limb(vict, 4);
                    ...
                    act("@R$N@r loses $s right leg!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@RYOU lose your right leg!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r loses $s right leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                    remove_limb(vict, 3);
                }
            }
        } else { /* It's a npc */
        ...
        if (rate > 0.00) {
            ...
            if (GET_CHARGE(ch) + add > GET_MAX_MANA(ch)) {
                if (GET_CHARGE(ch) < GET_MAX_MANA(ch)) {
                    ...
                    act("@MYou leech some of the energy away!@n", 1, ch, 0, 0, TO_CHAR);
                    act("@m$n@M leeches some of the energy away!@n", 1, ch, 0, 0, TO_ROOM);
                } else {
                    send_to_char(ch,
        ...
        if (rate > 0.00) {
            if (GET_CHARGE(ch) > 0 && rand_number(1, 100) <= 10) {
                act("@MThe attack causes your weak control to slip and you are shocked by your own charged energy!@n",
                    1, ch, 0, 0, TO_CHAR);
                act("@m$n@M suffers shock from their own charged energy!@n", 1, ch, 0, 0, TO_ROOM);
    ...
    if (!is_sparring(ch)) {
        if (area == 0) { /* Arms */
            if (GET_LIMBCOND(vict, 2) - dmg <= 0) {
                act("@RYour attack @YDESTROYS @r$N's@R left arm!@n", 1, ch, 0, vict, TO_CHAR);
                act("@r$n's@R attack @YDESTROYS@R YOUR left arm!@n", 1, ch, 0, vict, TO_VICT);
                act("@r$n's@R attack @YDESTROYS @r$N's@R left arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                GET_LIMBCOND(vict, 2) = 0;
                ...
                act("@RYour attack hurts @r$N's@R left arm!@n", 1, ch, 0, vict, TO_CHAR);
                act("@r$n's@R attack hurts YOUR left arm!@n", 1, ch, 0, vict, TO_VICT);
                act("@r$n's@R attack hurts @r$N's@R left arm!@n", 1, ch, 0, vict, TO_NOTVICT);
            } else if (GET_LIMBCOND(vict, 1) - dmg <= 0) {
                act("@RYour attack @YDESTROYS @r$N's@R right arm!@n", 1, ch, 0, vict, TO_CHAR);
                act("@r$n's@R attack @YDESTROYS@R YOUR right arm!@n", 1, ch, 0, vict, TO_VICT);
                act("@r$n's@R attack @YDESTROYS @r$N's@R right arm!@n", 1, ch, 0, vict, TO_NOTVICT);
                ...
                act("@RYour attack hurts @r$N's@R right arm!@n", 1, ch, 0, vict, TO_CHAR);
                act("@r$n's@R attack hurts YOUR right arm!@n", 1, ch, 0, vict, TO_VICT);
                act("@r$n's@R attack hurts @r$N's@R right arm!@n", 1, ch, 0, vict, TO_NOTVICT);
            }
        } else if (area == 1) { /* Legs */
            if (GET_LIMBCOND(vict, 4) - dmg <= 0) {
                act("@RYour attack @YDESTROYS @r$N's@R left leg!@n", 1, ch, 0, vict, TO_CHAR);
                act("@r$n's@R attack @YDESTROYS@R YOUR left leg!@n", 1, ch, 0, vict, TO_VICT);
                act("@r$n's@R attack @YDESTROYS @r$N's@R left leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                ...
                act("@RYour attack hurts @r$N's@R left leg!@n", 1, ch, 0, vict, TO_CHAR);
                act("@r$n's@R attack hurts YOUR left leg!@n", 1, ch, 0, vict, TO_VICT);
                act("@r$n's@R attack hurts @r$N's@R left leg!@n", 1, ch, 0, vict, TO_NOTVICT);
            } else if (GET_LIMBCOND(vict, 3) - dmg <= 0) {
                act("@RYour attack @YDESTROYS @r$N's@R right leg!@n", 1, ch, 0, vict, TO_CHAR);
                act("@r$n's@R attack @YDESTROYS@R YOUR right leg!@n", 1, ch, 0, vict, TO_VICT);
                act("@r$n's@R attack @YDESTROYS @r$N's@R right leg!@n", 1, ch, 0, vict, TO_NOTVICT);
                ...
                act("@RYour attack hurts @r$N's@R right leg!@n", 1, ch, 0, vict, TO_CHAR);
                act("@r$n's@R attack hurts YOUR right leg!@n", 1, ch, 0, vict, TO_VICT);
                act("@r$n's@R attack hurts @r$N's@R right leg!@n", 1, ch, 0, vict, TO_NOTVICT);
            }
        }
    }
}
...
void damage_eq(struct char_data *vict, int location) {
    ...
    if (GET_EQ(vict, location) && rand_number(1, 20) >= 19 && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
        ...
        if (GET_OBJ_VAL(eq, VAL_ALL_HEALTH) <= 0) {
            ...
            act("@WYour $p@W completely breaks!@n", 0, 0, eq, vict, TO_VICT);
            act("@C$N's@W $p@W completely breaks!@n", 0, 0, eq, vict, TO_NOTVICT);
            ...
            act("@WYour $p@W rips a little!@n", 0, 0, eq, vict, TO_VICT);
            act("@C$N's@W $p@W rips a little!@n", 0, 0, eq, vict, TO_NOTVICT);
            if (AFF_FLAGGED(vict, AFF_BLESS)) {
                send_to_char(vict, "@c...But your blessing seems to have partly mended this damage.@n\r\n");
                act("@c...but @C$N's@c body glows blue for a moment and the damage mends a little.@n", 1, 0, 0, vict,
                    TO_NOTVICT);
            } else if (AFF_FLAGGED(vict, AFF_CURSE)) {
                send_to_char(vict, "@r...and your curse seems to have made the damage three times worse!@n\r\n");
                act("@c...but @C$N's@c body glows red for a moment and the damage grow three times worse!@n", 1, 0,
                    0, vict, TO_NOTVICT);
            }
        } else {
            act("@WYour $p@W cracks a little!@n", 0, 0, eq, vict, TO_VICT);
            act("@C$N's@W $p@W cracks a little!@n", 0, 0, eq, vict, TO_NOTVICT);
            if (AFF_FLAGGED(vict, AFF_BLESS)) {
                send_to_char(vict, "@c...But your blessing seems to have partly mended this damage.@n\r\n");
                act("@c...but @C$N's@c body glows blue for a moment and the damage mends a little.@n", 1, 0, 0, vict,
                    TO_NOTVICT);
...
void update_mob_absorb() {
    ...
    for (i = character_list; i; i = i->next) {
        ...
        if (ABSORBING(i) == NULL || !ABSORBING(i))
            ...
            if (GET_HIT(vict) <= 0) {
                act("@R$n@r absorbs the last of YOUR energy and you die...@n", 1, i, 0, vict, TO_VICT);
                act("@R$n@r absorbs the last of @R$N's@r energy and $E dies...@n", 1, i, 0, vict, TO_NOTVICT);
                die(vict, i);
            } else if (maxed >= 3) {
                act("@R$n@r absorbs some of YOUR energy...but $e seems to be full now and releases YOU!@n", 1, i, 0,
                    vict, TO_VICT);
                act("@R$n@r absorbs some of @R$N's@r energy...but $e seems to be full now and lets go.@n", 1, i, 0,
                    vict, TO_NOTVICT);
            } else {
                act("@R$n@r absorbs some of YOUR energy!@n", 1, i, 0, vict, TO_VICT);
                act("@R$n@r absorbs some of @R$N's@r energy.@n", 1, i, 0, vict, TO_NOTVICT);
            }
...
void huge_update() {
    ...
    for (k = object_list; k; k = k->next) {
            ...
            if (KITYPE(k) == 497) {
                if (IN_ROOM(TARGET(k)) == IN_ROOM(k)) {
                    ...
                    if (GET_HIT(TARGET(k)) * bonus < KICHARGE(k) * 5) {
                        ...
                        for (vict = world[IN_ROOM(k)].people; vict; vict = next_v) {
                            ...
                            if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) ||
                                 AFF_FLAGGED(vict, AFF_ZANZOKEN)) && GET_MOVE(vict) >= 1 &&
                                GET_POS(vict) != POS_SLEEPING) {
                                act("@C$N@c disappears, avoiding the explosion!@n", 0, ch, 0, vict, TO_CHAR);
                                act("@cYou disappear, avoiding the explosion!@n", 0, ch, 0, vict, TO_VICT);
                                act("@C$N@c disappears, avoiding the explosion!@n", 0, ch, 0, vict, TO_NOTVICT);
                    ...
                    for (vict = world[IN_ROOM(k)].people; vict; vict = next_v) {
                        ...
                        dge = handle_dodge(vict);
                        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) ||
                             AFF_FLAGGED(vict, AFF_ZANZOKEN)) && GET_MOVE(vict) >= 1 && GET_POS(vict) != POS_SLEEPING) {
                            act("@C$N@c disappears, avoiding the explosion!@n", 0, ch, 0, vict, TO_CHAR);
                            act("@cYou disappear, avoiding the explosion!@n", 0, ch, 0, vict, TO_VICT);
                            act("@C$N@c disappears, avoiding the explosion!@n", 0, ch, 0, vict, TO_NOTVICT);
                            REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
        ...
        act("$p@W descends slowly towards the ground!@n", 1, 0, k, 0, TO_ROOM);
        KIDIST(k)--;
    }
        ...
        if (GET_OBJ_VNUM(k) != 80 && GET_OBJ_VNUM(k) != 81 && GET_OBJ_VNUM(k) != 84) {
            ...
            if (GET_OBJ_VNUM(k) == 80) { // Tsuihidan
                if (IN_ROOM(k) != IN_ROOM(vict)) {
                    act("@wThe $p@w pursues after you!@n", 1, vict, k, 0, TO_CHAR);
                    act("@wThe $p@W pursues after @C$n@w!@n", 1, vict, k, 0, TO_ROOM);
                    obj_from_room(k);
                    obj_to_room(k, IN_ROOM(vict));
                    continue;
                } else {
                    act("@RThe $p@R makes a tight turn and rockets straight for you!@n", 1, vict, k, 0, TO_CHAR);
                    act("@RThe $p@R makes a tight turn and rockets straight for @r$n@n", 1, vict, k, 0, TO_ROOM);
                    if (handle_parry(vict) < rand_number(1, 140)) {
                        act("@rThe $p@r slams into your body, exploding in a flash of bright light!@n", 1, vict, k,
                            0, TO_CHAR);
                        act("@rThe $p@r slams into @R$n's@r body, exploding in a flash of bright light!@n", 1, vict,
                            k, 0, TO_ROOM);
                ...
                if (IN_ROOM(k) != IN_ROOM(vict)) {
                    act("@wYou lose sight of @C$N@W and let $p@W fly away!@n", 1, ch, k, vict, TO_CHAR);
                    act("@wYou manage to escape @C$n's@W $p@W!@n", 1, ch, k, vict, TO_VICT);
                    act("@C$n@W loses sight of @c$N@W and lets $s $p@W fly away!@n", 1, ch, k, vict, TO_NOTVICT);
                    extract_obj(k);
                    continue;
                } else {
                    act("@RYou move your hand and direct $p@R after @r$N@R!@n", 1, ch, k, vict, TO_CHAR);
                    act("@r$n@R moves $s hand and directs $p@R after YOU!@n", 1, ch, k, vict, TO_VICT);
                    act("@r$n@R moves $s hand and directs $p@R after @r$N@R!@n", 1, ch, k, vict, TO_NOTVICT);
                    if (handle_parry(vict) < rand_number(1, 140)) {
                        if (GET_OBJ_VNUM(k) != 84) {
                            act("@rThe $p@r slams into your body, exploding in a flash of bright light!@n", 1, vict,
                                k, 0, TO_CHAR);
                            act("@rThe $p@r slams into @R$n's@r body, exploding in a flash of bright light!@n", 1,
                                vict, k, 0, TO_ROOM);
                            int64_t dmg = KICHARGE(k);
                            extract_obj(k);
                            hurt(0, 0, ch, vict, NULL, dmg, 1);
                            ...
                            if (dmg > GET_MAX_HIT(vict) / 5 && (!IS_MAJIN(vict) && !IS_BIO(vict))) {
                                ...
                                if (GET_SKILL(vict, SKILL_REGENERATE) > rand_number(1, 101) &&
                                    ...
                                    act("@R$N@r is cut in half by the attack but regenerates a moment later!@n", 1,
                                        ch, 0, vict, TO_CHAR);
                                    act("@rYou are cut in half by the attack but regenerate a moment later!@n", 1,
                                        ch, 0, vict, TO_VICT);
                                    act("@R$N@r is cut in half by the attack but regenerates a moment later!@n", 1,
                                ...
                                act("@rThe $p@r slams into your body, exploding in a flash of bright light!@n", 1,
                                    vict, k, 0, TO_CHAR);
...
bool limb_ok(struct char_data *ch, int type) {
    if (IS_NPC(ch)) {
    ...
    if (type == 0) {
        ...
        if (AFF_FLAGGED(ch, AFF_ENSNARED) && rand_number(1, 100) <= 90) {
            ...
            act("You manage to break the silk ensnaring your arms!", 1, ch, 0, 0, TO_CHAR);
            act("$n manages to break the silk ensnaring $s arms!", 1, ch, 0, 0, TO_ROOM);
...
parry_ki(double attperc, struct char_data *ch, struct char_data *vict, char sname[1000], int prob, int perc, int skill,
    ...
    for (tch = world[IN_ROOM(ch)].people; tch; tch = next_v) {
        ...
        if (rand_number(1, 101) >= 90 && foundv == 0) {
            if (handle_parry(tch) > rand_number(1, 140)) {
                ...
                act(buf, 1, ch, 0, tch, TO_CHAR);
                act(buf2, 1, ch, 0, tch, TO_VICT);
                act(buf3, 1, ch, 0, tch, TO_NOTVICT);
                foundv = 0;
            } else {
                foundv = 1;
                sprintf(buf,
                ...
                sprintf(buf3,
                        ...
                        sname, sname);
                act(buf, 1, vict, 0, tch, TO_CHAR);
                act(buf2, 1, vict, 0, tch, TO_VICT);
                act(buf3, 1, vict, 0, tch, TO_NOTVICT);
    ...
    for (tob = world[IN_ROOM(ch)].contents; tob; tob = next_obj) {
        ...
        if (rand_number(1, 101) >= 80) {
            ...
            sprintf(buf2,
                    ...
                    sname);
            act(buf, 1, vict, tob, 0, TO_CHAR);
            act(buf2, 1, vict, tob, 0, TO_ROOM);
            hurt(0, 0, ch, NULL, tob, 25, 1);
            return;
        }
    }

    if ((foundo == 0 || foundv == 0) && !ROOM_FLAGGED(IN_ROOM(vict), ROOM_SPACE)) {
        sprintf(buf,
        ...
        act(buf, 1, vict, 0, 0, TO_CHAR);
        act(buf2, 1, vict, 0, 0, TO_ROOM);
        if (SECT(IN_ROOM(vict)) != SECT_INSIDE && SECT(IN_ROOM(vict)) != SECT_UNDERWATER &&
            ...
            switch (rand_number(1, 8)) {
                case 1:
                    act("Debris is thrown into the air and showers down thunderously!", 1, ch, 0, vict, TO_CHAR);
                    act("Debris is thrown into the air and showers down thunderously!", 1, ch, 0, vict, TO_ROOM);
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    act("The surrounding area roars and shudders from the impact!", 1, ch, 0, vict, TO_CHAR);
                    act("The surrounding area roars and shudders from the impact!", 1, ch, 0, vict, TO_ROOM);
                    break;
                case 5:
                    act("The ground shatters apart from the stress of the impact!", 1, ch, 0, vict, TO_CHAR);
                    act("The ground shatters apart from the stress of the impact!", 1, ch, 0, vict, TO_ROOM);
                    break;
                case 6:
        ...
        if (SECT(IN_ROOM(vict)) == SECT_WATER_SWIM || SECT(IN_ROOM(vict)) == SECT_WATER_NOSWIM) {
            switch (rand_number(1, 3)) {
                case 1:
                    ...
                    break;
                case 2:
                    act("The impact briefly causes a swirling vortex of water!", 1, ch, 0, vict, TO_CHAR);
                    act("The impact briefly causes a swirling vortex of water!", 1, ch, 0, vict, TO_ROOM);
                    break;
                case 3:
        ...
        if (SECT(IN_ROOM(vict)) == SECT_INSIDE) {
            ...
            switch (rand_number(1, 8)) {
                case 1:
                    ...
                    break;
                case 2:
                    act("The structure of the surrounding room cracks and quakes from the blast!", 1, ch, 0, vict,
                        TO_CHAR);
                    act("The structure of the surrounding room cracks and quakes from the blast!", 1, ch, 0, vict,
                        TO_ROOM);
                    break;
                case 3:
                    act("Parts of the ceiling collapse, crushing into the floor!", 1, ch, 0, vict, TO_CHAR);
                    act("Parts of the ceiling collapse, crushing into the floor!", 1, ch, 0, vict, TO_ROOM);
                    break;
                case 4:
                    act("The surrounding area roars and shudders from the impact!", 1, ch, 0, vict, TO_CHAR);
                    act("The surrounding area roars and shudders from the impact!", 1, ch, 0, vict, TO_ROOM);
                ...
                case 5:
                    ...
                    break;
                case 6:
                    act("The walls of the surrounding room crack in the same instant!", 1, ch, 0, vict, TO_CHAR);
                    act("The walls of the surrounding room crack in the same instant!", 1, ch, 0, vict, TO_ROOM);
                    break;
                default:
                    /* we want no message for the default */
                    break;
...
void dodge_ki(struct char_data *ch, struct char_data *vict, int type, int type2, int skill, int skill2) {
    ...
    if (type == 1) {
        if (rand_number(1, 3) != 2) {
            act("@RIt turns around at the last second and begins to pursue @r$N@R!@n", 1, ch, 0, vict, TO_CHAR);
            act("@RIt turns around at the last second and begins to pursue YOU!@n", 1, ch, 0, vict, TO_VICT);
            act("@RIt turns around at the last second and begins to pursue @r$N@R!@n", 1, ch, 0, vict, TO_NOTVICT);
            struct obj_data *obj;
            int num = 0;
            ...
            act("@RIt fails to follow after @r$N@R!@n", 1, ch, 0, vict, TO_CHAR);
            act("@RIt fails to follow after YOU!@n", 1, ch, 0, vict, TO_VICT);
            act("@RIt fails to follow after @r$N@R!@n", 1, ch, 0, vict, TO_NOTVICT);
        }
    }
    if (type == 2 && (skill2 != 481 || IS_FRIEZA(ch))) {
        ...
        act("@RYou turn it around and send it back after @r$N@R!@n", 1, ch, 0, vict, TO_CHAR);
        act("@W$n @Rturns it around and sends it back after YOU!@n", 1, ch, 0, vict, TO_VICT);
        act("@W$n @Rturns it around and sends it back after @r$N@R!@n", 1, ch, 0, vict, TO_NOTVICT);
        struct obj_data *obj;
        int num = 0;
...
int64_t damtype(struct char_data *ch, int type, int skill, double percent) {
    ...
    if (PLR_FLAGGED(ch, PLR_FURY) &&
        (type == 0 || type == 1 || type == 2 || type == 3 || type == 4 || type == 5 || type == 6 || type == 8 ||
         type == 51 || type == 52)) {
        dam *= 1.5;
        act("Your rage magnifies your attack power!", 1, ch, 0, 0, TO_CHAR);
        act("Swirling energy flows around $n as $e releases $s rage in the attack!", 1, ch, 0, 0, TO_ROOM);
...
bool can_kill(struct char_data *ch, struct char_data *vict, struct obj_data *obj, int num) {
    /* Target Related */
    ...
    if (vict) {
        ...
        if (ROOM_FLAGGED(IN_ROOM(ch), ROOM_PEACEFUL)) {
            ...
            act("@GYou stretch your limbs toward @g$N@G in an attempt to hit $M!@n", 1, ch, 0, vict, TO_CHAR);
            act("@g$n@G stretches $s limbs toward @RYOU@G in an attempt to land a hit!@n", 1, ch, 0, vict, TO_VICT);
            act("@g$n@G stretches $s limbs toward @g$N@G in an attempt to hit $M!@n", 1, ch, 0, vict, TO_NOTVICT);
            return true;
...
bool check_skill(struct char_data *ch, int skill) {
   ...
   if (PLR_FLAGGED(ch, PLR_TRANS3)) {
    ...
    if (AFF_FLAGGED(ch, AFF_INFUSE) && !AFF_FLAGGED(ch, AFF_HASS) && type <= 0) {
        if (GET_MANA(ch) - (GET_MAX_MANA(ch) * 0.005) > 0 && dmg > 1) {
            ...
            act("@wYou can no longer infuse ki into your attacks!@n", 1, ch, 0, 0, TO_CHAR);
            act("@c$n@w can no longer infuse ki into $s attacks!@n", 1, ch, 0, 0, TO_ROOM);
    ...
    if (vict) {
        ...
        if (IS_MUTANT(vict) && (GET_GENOME(vict, 0) == 8 || GET_GENOME(vict, 1) == 8) && type == 0) {
            ...
            act("@Y$N's rubbery body makes hitting it tiring!@n", 1, ch, 0, vict, TO_CHAR);
            act("@Y$n's stamina is sapped a bit by hitting your rubbery body!@n", 1, ch, 0, vict, TO_VICT);
        }
        ...
        if (AFF_FLAGGED(vict, AFF_SANCTUARY)) {
            ...
            if (GET_BARRIER(vict) - dmg > 0) {
                act("@c$N's@C barrier absorbs the damage!@n", 1, ch, 0, vict, TO_CHAR);
                char barr[MAX_INPUT_LENGTH];
                sprintf(barr, "@CYour barrier absorbs the damage! @D[@B%s@D]@n", add_commas(dmg));
                act(barr, 1, ch, 0, vict, TO_VICT);
                act("@c$N's@C barrier absorbs the damage!@n", 1, ch, 0, vict, TO_NOTVICT);
                GET_BARRIER(vict) -= dmg;
                dmg = 0;
            } else if (GET_BARRIER(vict) - dmg <= 0) {
                dmg -= GET_BARRIER(vict);
                GET_BARRIER(vict) = 0;
                act("@c$N's@C barrier bursts!@n", 1, ch, 0, vict, TO_CHAR);
                act("@CYour barrier bursts!@n", 1, ch, 0, vict, TO_VICT);
                act("@c$N's@C barrier bursts!@n", 1, ch, 0, vict, TO_NOTVICT);
        ...
        if (AFF_FLAGGED(vict, AFF_FIRESHIELD) && rand_number(1, 200) < GET_SKILL(vict, SKILL_FIRESHIELD)) {
            act("@c$N's@C fireshield repels the damage!@n", 1, ch, 0, vict, TO_CHAR);
            act("@CYour fireshield repels the damage!@n", 1, ch, 0, vict, TO_VICT);
            act("@c$N's@C fireshield repels the damage!@n", 1, ch, 0, vict, TO_NOTVICT);
            if (rand_number(1, 3) == 3) {
                act("@c$N's@C fireshield disappears...@n", 1, ch, 0, vict, TO_CHAR);
                act("@CYour fireshield disappears...@n", 1, ch, 0, vict, TO_VICT);
                act("@c$N's@C fireshield disappears...@n", 1, ch, 0, vict, TO_NOTVICT);
        ...
        if (GET_CLAN(vict) != NULL && !strcasecmp(GET_CLAN(vict), "Heavenly Kaios")) {
            if (GET_MANA(vict) >= GET_MAX_MANA(vict) / 2) {
                dmg -= (dmg / 100) * 20;
                act("@wYou are covered in a pristine @Cglow@w.@n", 1, vict, 0, 0, TO_CHAR);
                act("@w$n is covered in a pristine @Cglow@w!@n", 1, vict, 0, 0, TO_ROOM);
            }
        }
        ...
        if (!IS_NPC(vict) && GET_SKILL(vict, SKILL_ARMOR)) {
            ...
            if (nanite >= perc) {
                if (PLR_FLAGGED(vict, PLR_TRANS6)) {
                    act("@WYour @gn@Ga@Wn@wite @Da@Wr@wm@Do@wr@W reacts in time to block MOST of the damage!@n", 1,
                        vict, 0, 0, TO_CHAR);
                    act("@W$n's @gn@Ga@Wn@wite @Da@Wr@wm@Do@wr@W reacts in time to block MOST of the damage!@n", 1,
                        vict, 0, 0, TO_ROOM);
                    dmg -= (dmg * 0.01) * 50;
                } else if (PLR_FLAGGED(vict, PLR_TRANS5)) {
                    act("@WYour @gn@Ga@Wn@wite @Da@Wr@wm@Do@wr@W reacts in time to block some of the damage!@n", 1,
                        vict, 0, 0, TO_CHAR);
                    act("@W$n's @gn@Ga@Wn@wite @Da@Wr@wm@Do@wr@W reacts in time to block some of the damage!@n", 1,
                        vict, 0, 0, TO_ROOM);
                    dmg -= (dmg * 0.01) * 40;
                } else if (PLR_FLAGGED(vict, PLR_TRANS4)) {
                    act("@WYour @gn@Ga@Wn@wite @Da@Wr@wm@Do@wr@W reacts in time to block a lot of the damage!@n", 1,
                        vict, 0, 0, TO_CHAR);
                    act("@W$n's @gn@Ga@Wn@wite @Da@Wr@wm@Do@wr@W reacts in time to block a lot of the damage!@n", 1,
                        vict, 0, 0, TO_ROOM);
                    dmg -= (dmg * 0.01) * 30;
                    ...
                    act("@WYour @gn@Ga@Wn@wite @Da@Wr@wm@Do@wr@W reacts in time to block a bit of the damage!@n", 1,
                        vict, 0, 0, TO_CHAR);
                    act("@W$n's @gn@Ga@Wn@wite @Da@Wr@wm@Do@wr@W reacts in time to block a bit of the damage!@n", 1,
                        vict, 0, 0, TO_ROOM);
                    dmg -= (dmg * 0.01) * 10;
                } else {
        ...
        if (!AFF_FLAGGED(vict, AFF_KNOCKED) && (GET_POS(vict) == POS_SITTING || GET_POS(vict) == POS_RESTING) &&
            ...
            if (GET_MOVE(vict) >= rollcost) {
                act("@GYou roll to your feet in an agile fashion!@n", 1, vict, 0, 0, TO_CHAR);
                act("@G$n rolls to $s feet in an agile fashion!@n", 1, vict, 0, 0, TO_ROOM);
                do_stand(vict, 0, 0, 0);
        ...
        if (AFF_FLAGGED(vict, AFF_SLEEP) && rand_number(1, 2) == 2) {
            ...
            act("@c$N@W seems to be more aware now.@n", 1, ch, 0, vict, TO_CHAR);
            act("@WYou are no longer so sleepy.@n", 1, ch, 0, vict, TO_VICT);
            act("@c$N@W seems to be more aware now.@n", 1, ch, 0, vict, TO_NOTVICT);
        }
        if (AFF_FLAGGED(vict, AFF_KNOCKED) && rand_number(1, 12) >= 11) {
            act("@W$n@W is no longer senseless, and wakes up.@n", 0, vict, 0, 0, TO_ROOM);
            ...
            if (IS_NPC(vict) && rand_number(1, 20) >= 12) {
                act("@W$n@W stands up.@n", 0, vict, 0, 0, TO_ROOM);
        ...
        if (IS_NPC(vict) && dmg > GET_MAX_HIT(vict) * .7 && GET_BONUS(ch, BONUS_SADISTIC) > 0) {
            GET_EXP(vict) /= 2;
        } else if (IS_NPC(vict) && dmg > GET_HIT(vict) && GET_HIT(vict) >= GET_MAX_HIT(vict) * .5 &&
        ...
        if (is_sparring(ch) && is_sparring(vict) && (GET_SUPP(vict) + GET_HIT(vict)) - dmg <= 0) {
            if (!IS_NPC(vict)) {
                act("@c$N@w falls down unconscious, and you stop sparring with $M.@n", 1, ch, 0, vict, TO_CHAR);
                act("@C$n@w stops sparring with you as you fall unconscious.@n", 1, ch, 0, vict, TO_VICT);
                act("@c$N@w falls down unconscious, and @C$n@w stops sparring with $M.@n", 1, ch, 0, vict,
                    TO_NOTVICT);
                GET_HIT(vict) = 1;
                if (GET_SUPP(vict) > 0) {
                    GET_SUPP(vict) = 0;
                ...
                act("@c$N@w admits defeat to you, stops sparring, and stumbles away.@n", 1, ch, 0, vict, TO_CHAR);
                act("@c$N@w admits defeat to $n, stops sparring, and stumbles away.@n", 1, ch, 0, vict, TO_NOTVICT);
                solo_gain(ch, vict);
                ...
                if (founded == 1) {
                    act("@c$N@w leaves a reward behind out of respect.@n", 1, ch, 0, vict, TO_CHAR);
                }
                GET_HIT(vict) = 0;
                extract_char(vict);
                return;
            ...
            act("@c$N@w falls down unconscious, and you spare $S life.@n", 1, ch, 0, vict, TO_CHAR);
            act("@C$n@w spares your life as you fall unconscious.@n", 1, ch, 0, vict, TO_VICT);
            act("@c$N@w falls down unconscious, and @C$n@w spares $S life.@n", 1, ch, 0, vict, TO_NOTVICT);
            GET_HIT(vict) = 1;
            if (FIGHTING(vict)) {
                stop_fighting(vict);
            }
            ...
            act("@w$n@w stops sparring!@n", 1, ch, 0, vict, TO_ROOM);
        ...
        if (PLR_FLAGGED(vict, PLR_IMMORTAL) && !is_sparring(ch) && GET_HIT(vict) - dmg <= 0) {
            if (IN_ARENA(vict)) {
                ...
                act("@c$N@w disappears right before dying. $N appears to be immortal.@n", 1, ch, 0, vict, TO_CHAR);
                act("@CYou disappear right before death, having been saved by your immortality.@n", 1, ch, 0, vict,
                    TO_VICT);
                act("@c$N@w disappears right before dying. $N appears to be immortal.@n.", 1, ch, 0, vict,
                    TO_NOTVICT);
                GET_HIT(vict) = 1;
                GET_MANA(vict) = 1;
                GET_MOVE(vict) = 1;
        ...
        if (GRAPPLING(vict) && GRAPPLING(vict) != ch && type == 1) {
            act("@YThe attack hurts YOU as well because you are grappling with $M!@n", 1, vict, 0, GRAPPLING(vict),
                TO_VICT);
            act("@YThe attack hurts @y$N@Y as well because $n is grappling with $m!@n", 1, vict, 0, GRAPPLING(vict),
                TO_NOTVICT);
            maindmg = maindmg / 2;
            hurt(0, 0, ch, GRAPPLING(vict), NULL, maindmg, 3);
        }
        if (GRAPPLED(vict) && GRAPPLED(vict) != ch && type == 1) {
            act("@YThe attack hurts YOU as well because you are being grappled by $M!@n", 1, vict, 0, GRAPPLED(vict),
                TO_VICT);
            act("@YThe attack hurts @y$N@Y as well because $n is being grappled by $m!@n", 1, vict, 0,
        ...
        if (!is_sparring(ch) && !PLR_FLAGGED(vict, PLR_IMMORTAL) && GET_HIT(vict) - dmg <= 0) {
            if (GET_HIT(vict) - dmg <= 0 && suppresso == 0) {
                GET_HIT(vict) = 0;
                if (!IS_NPC(vict) && GET_LIFEFORCE(vict) - (dmg - GET_HIT(vict)) >= 0) {
                    act("@c$N@w barely clings to life!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@CYou barely cling to life!@n", 1, ch, 0, vict, TO_VICT);
                    act("@c$N@w barely clings to life!@n.", 1, ch, 0, vict, TO_NOTVICT);
                ...
                if (type <= 0 && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    ...
                    act("@R$N@w self destructs with a mild explosion!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@R$N@w self destructs with a mild explosion!@n", 1, ch, 0, vict, TO_ROOM);
                }
                if (dmg > 1) {
                    ...
                    if (AFF_FLAGGED(ch, AFF_METAMORPH) && GET_HIT(ch) <= GET_MAX_HIT(ch)) {
                        act("@RYour dark aura saps some of @r$N's@R life energy!@n", 1, ch, 0, vict, TO_CHAR);
                        act("@r$n@R's dark aura saps some of your life energy!@n", 1, ch, 0, vict, TO_VICT);
                        GET_HIT(ch) += healhp;
                    }
        ...
        } else if (GET_HIT(vict) - dmg > 0 || suppresso == 1) {
            if (suppresso == 0) {
                GET_HIT(vict) -= dmg;
            }
            if (FIGHTING(ch) == NULL) {
            ...
            if (dmg > 1 && suppresso == 0) {
                ...
                if (dmg <= 1 && suppresso == 0 && !PRF_FLAGGED(ch, PRF_NODEC)) {
                    send_to_char(ch, "@D[@GDamage@W: @BPitiful...@D]@n");
                    send_to_char(vict, "@D[@rDamage@W: @BPitiful...@D]@n\r\n");
                    if (GET_EQ(ch, WEAR_EYE) && vict && !PRF_FLAGGED(ch, PRF_NODEC)) {
                        if (IS_ANDROID(vict)) {
                ...
                } else if (dmg > 1 && suppresso == 1 && !PRF_FLAGGED(ch, PRF_NODEC)) {
                    send_to_char(ch, "@D[@GDamage@W: @R%s@D]@n", add_commas(dmg));
        ...
        if (IS_ARLIAN(vict) && dead != 1 && !is_sparring(vict) && !is_sparring(ch)) {
        ...
        if (OBJ_FLAGGED(obj, ITEM_UNBREAKABLE)) {
            act("$p@w seems unaffected.@n", 1, ch, obj, 0, TO_CHAR);
            act("$p@w seems unaffected.@n", 1, ch, obj, 0, TO_ROOM);
        } else if (GET_OBJ_VNUM(obj) == 79) {
            if (GET_OBJ_WEIGHT(obj) - dmg > 0) {
                if (type <= 0) {
                    if (AFF_FLAGGED(ch, AFF_INFUSE))
                        dmg *= 10;
                    act("$p@w cracks some.@n", 1, ch, obj, 0, TO_CHAR);
                    act("$p@w cracks some.@n", 1, ch, obj, 0, TO_ROOM);
                    GET_OBJ_WEIGHT(obj) -= dmg;
                    if (GET_FELLOW_WALL(obj)) {
                        struct obj_data *wall;
                        wall = GET_FELLOW_WALL(obj);
                        GET_OBJ_WEIGHT(wall) -= dmg;
                        act("$p@w cracks some. A humanoid shadow can be seen moving on the other side.@n", 1, 0, obj,
                            0, TO_ROOM);
                    }
                } else {
                    dmg *= 30;
                    act("$p@w melts some.@n", 1, ch, obj, 0, TO_CHAR);
                    act("$p@w melts some.@n", 1, ch, obj, 0, TO_ROOM);
                    GET_OBJ_WEIGHT(obj) -= dmg;
                    if (GET_FELLOW_WALL(obj)) {
                        struct obj_data *wall;
                        wall = GET_FELLOW_WALL(obj);
                ...
                if (type <= 0) {
                    act("$p@w breaks completely apart and then melts away.@n", 1, ch, obj, 0, TO_CHAR);
                    act("$p@w breaks completely apart and then melts away.@n", 1, ch, obj, 0, TO_ROOM);
                    extract_obj(obj);
                } else {
                    act("$p@w is blown away into snow and water!@n", 1, ch, obj, 0, TO_CHAR);
                    act("$p@w is blown away into snow and water!@n", 1, ch, obj, 0, TO_ROOM);
                    extract_obj(obj);
                }
            }
            ...
            if (type <= 0) {
                act("$p@w shatters apart!@n", 1, ch, obj, 0, TO_CHAR);
                act("$p@w shatters apart!@n", 1, ch, obj, 0, TO_ROOM);
                ...
                act("$p@w is disintegrated!@n", 1, ch, obj, 0, TO_CHAR);
                act("$p@w is disintegrated!@n", 1, ch, obj, 0, TO_ROOM);
                extract_obj(obj);
            }
        }
    } else {
...
void handle_spiral(struct char_data *ch, struct char_data *vict, int skill, int first) {
    ...
    if (vict == NULL && FIGHTING(ch)) {
        ...
        act("@WHaving lost your target you slow down until your vortex disappears, and end your attack.@n", 1, ch, 0,
            0, TO_CHAR);
        act("@C$n@W slows down until $s vortex disappears.@n", 1, ch, 0, 0, TO_ROOM);
        REMOVE_BIT_AR(PLR_FLAGS(ch), PLR_SPIRAL);
        return;
    }

    if (GET_CHARGE(ch) <= 0) {
        act("@WHaving no more charged ki you slow down until your vortex disappears, and end your attack.@n", 1, ch,
            0, 0, TO_CHAR);
        act("@C$n@W slows down until $s vortex disappears.@n", 1, ch, 0, 0, TO_ROOM);
        REMOVE_BIT_AR(PLR_FLAGS(ch), PLR_SPIRAL);
        return;
    ...
    if (vict) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            if (!AFF_FLAGGED(ch, AFF_ZANZOKEN) || (AFF_FLAGGED(ch, AFF_ZANZOKEN) && GET_SPEEDI(ch) + rand_number(1, 5) <
                                                                                    GET_SPEEDI(vict) +
                                                                                    rand_number(1, 5))) {
                act("@C$N@c disappears, avoiding your Spiral Comet blast before reappearing!@n", 0, ch, 0, vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding @C$n's@c Spiral Comet blast before reappearing!@n", 0, ch, 0, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding @C$n's@c Spiral Comet blast before reappearing!@n", 0, ch, 0, vict,
                    TO_NOTVICT);
        ...
        if (prob < perc) {
            if (GET_MOVE(vict) > 0) {
                if (blk > rand_number(1, 130)) {
                    act("@C$N@W moves quickly and blocks your Spiral Comet blast!@n", 0, ch, 0, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Spiral Comet blast!@n", 0, ch, 0, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Spiral Comet blast!@n", 0, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, amount, 0);
                    ...
                    act("@C$N@W manages to dodge your Spiral Comet blast, letting it slam into the surroundings!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Spiral Comet blast, letting it slam into the surroundings!@n", 0, ch,
                        0, vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your Spiral Comet blast misses, flying through the air harmlessly!@n",
                        0, ch, 0, vict, TO_CHAR);
                    act("@C$n@W fires a Spiral Comet blast at you, but misses!@n ", 0, ch, 0, vict, TO_VICT);
                    act("@c$n@W fires a Spiral Comet blast at @C$N@W, but somehow misses!@n ", 0, ch, 0, vict,
                        TO_NOTVICT);
                    pcost(ch, amount, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
...
void handle_death_msg(struct char_data *ch, struct char_data *vict, int type) {
    if (type == 0) {
        if (!SUNKEN(IN_ROOM(vict)) && SECT(IN_ROOM(vict)) != SECT_WATER_SWIM &&
            ...
            switch (rand_number(1, 5)) {
                case 1:
                    act("@R$N@r coughs up blood before falling to the ground dead.@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYou cough up blood before falling to the ground dead.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r coughs up blood before falling down dead.@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
                case 2:
                    act("@R$N@r crumples to the ground dead.@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYou crumple to the ground dead.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r crumples to the ground dead.@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
                case 3:
                    act("@R$N@r cries out $S last breath before dying.@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYou cry out your last breath before dying.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r cries out $S last breath before dying.@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
                case 4:
                    act("@R$N@r writhes on the ground screaming in pain before finally dying!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@rYou writhe on the ground screaming in pain before finally dying!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@R$N@r writhes on the ground screaming in pain before finally dying!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_DEATH_TYPE(vict) != DTYPE_HEAD) {
                    ...
                    break;
                case 5:
                    act("@R$N@r hits the ground dead with such force that blood flies into the air briefly!@n", 1,
                        ch, 0, vict, TO_CHAR);
                    act("@rYou hit the ground dead with such force that blood flies into the air briefly!@n", 1, ch,
                        0, vict, TO_VICT);
                    act("@R$N@r hits the ground dead with such force that blood flies into the air briefly!@n", 1,
                        ch, 0, vict, TO_NOTVICT);
                    if (GET_DEATH_TYPE(vict) != DTYPE_HEAD) {
            ...
            switch (rand_number(1, 5)) {
                ...
                case 2:
                    act("@R$N@r crumples down to the water, with the signs of life leaving $S eyes as $E floats in the water.@n",
                        1, ch, 0, vict, TO_CHAR);
                    act("@rYou crumple down to the water and die.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r crumples down to the water, with the signs of life leaving $S eyes as $E floats in the water.@n",
                        1, ch, 0, vict, TO_NOTVICT);
                    break;
                case 3:
                    act("@R$N@r cries out $S last breath before dying and leaving a floating corpse behind.@n", 1,
                        ch, 0, vict, TO_CHAR);
                    act("@rYou cry out your last breath before dying.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r cries out $S last breath before dying and leaving a floating corpse behind.@n", 1,
                        ch, 0, vict, TO_NOTVICT);
                    break;
                case 4:
                    act("@R$N@r writhes in the water screaming in pain before finally dying!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@rYou writhe in the water screaming in pain before finally dying!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@R$N@r writhes in the water screaming in pain before finally dying!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_DEATH_TYPE(vict) != DTYPE_HEAD) {
            ...
            switch (rand_number(1, 5)) {
                case 1:
                    act("@R$N@r coughs up blood and dies. The blood freezes and floats freely through space...@n", 1,
                        ch, 0, vict, TO_CHAR);
                    act("@rYou cough up blood and die. The blood freezes and floats freely through space...@n", 1,
                        ch, 0, vict, TO_VICT);
                    act("@R$N@r coughs up blood and dies. The blood freezes and floats freely through space...@n", 1,
                        ch, 0, vict, TO_NOTVICT);
                    break;
                case 2:
                    act("@R$N@r dies and leaves $S corpse floating freely in space.@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYou die and leave your corpse floating freely in space.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r dies and leaves $S corpse floating freely in space.@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
                case 3:
                    act("@R$N@r cries out $S last breath before dying.@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYou cry out your last breath before dying.@n", 1, ch, 0, vict, TO_VICT);
                    ...
                    break;
                case 4:
                    act("@R$N@r writhes in space trying to scream in pain before $e finally dies!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@rYou writhe in space trying to scream in pain before you finally die!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@R$N@r writhes in space trying to scream in pain before $e finally dies!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_DEATH_TYPE(vict) != DTYPE_HEAD) {
                    ...
                    break;
                case 5:
                    act("@R$N@r dies suddenly leaving behind a badly damaged corpse floating in space!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@rYou die suddenly leaving behind a badly damaged corpse floating in space!@n", 1, ch, 0,
                        vict, TO_VICT);
                    act("@R$N@r dies suddenly leaving behind a badly damaged corpse floating in space!@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                    if (GET_DEATH_TYPE(vict) != DTYPE_HEAD) {
            ...
            switch (rand_number(1, 5)) {
                case 1:
                    act("@R$N@r coughs up blood before $s corpse starts to fall to the ground far below.@n", 1, ch,
                        0, vict, TO_CHAR);
                    act("@rYou coughs up blood before your corpse starts to fall to the ground far below.@n", 1, ch,
                        0, vict, TO_VICT);
                    act("@R$N@r coughs up blood before $s corpse starts to fall to the ground far below.@n", 1, ch,
                        0, vict, TO_NOTVICT);
                    break;
                case 2:
                    act("@R$N@r dies and $S corpse begins to fall to the ground below.@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYou die and your corpse begins to fall to the ground below.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r dies and $S corpse begins to fall to the ground below.@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    break;
                case 3:
                    act("@R$N@r cries out $S last breath before dying.@n", 1, ch, 0, vict, TO_CHAR);
                    ...
                    break;
                case 4:
                    act("@R$N@r writhes in midair screaming in pain before finally dying!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@rYou writhe in midair screaming in pain before finally dying!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r writhes in midair screaming in pain before finally dying!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    if (GET_DEATH_TYPE(vict) != DTYPE_HEAD) {
                        GET_DEATH_TYPE(vict) = DTYPE_PULP;
                    ...
                    break;
                case 5:
                    act("@R$N@r snaps back and dies with such force that blood flies into the air briefly!@n", 1, ch,
                        0, vict, TO_CHAR);
                    act("@rYou snap back and die with such force that blood flies into the air briefly!@n", 1, ch, 0,
                        vict, TO_VICT);
                    act("@R$N@r hits the ground dead with such force that blood flies into the air briefly!@n", 1,
                        ch, 0, vict, TO_NOTVICT);
                    if (GET_DEATH_TYPE(vict) != DTYPE_HEAD) {
            ...
            switch (rand_number(1, 5)) {
                case 1:
                    act("@R$N@r coughs up blood before $s corpse starts to float limply in the water.@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@rYou coughs up blood before your corpse starts to float limply in the water.@n", 1, ch, 0,
                        vict, TO_VICT);
                    act("@R$N@r coughs up blood before $s corpse starts to float limply in the water.@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                    break;
                case 2:
                    act("@R$N@r dies and $S corpse begins to float limply in the water.@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYou die and your corpse begins to float limply in the water.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r dies and $S corpse begins to float limply in the water.@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    break;
                case 3:
                    act("@R$N@r cries out $S last breath before dying.@n", 1, ch, 0, vict, TO_CHAR);
                    ...
                    break;
                case 4:
                    act("@R$N@r writhes and thrases in the water trying to scream before finally dying!@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@rYou writhe and thrash in the water trying to scream before finally dying!@n", 1, ch, 0,
                        vict, TO_VICT);
                    act("@R$N@r writhes and thrashes in the water trying to scream before finally dying!@n", 1, ch,
                        0, vict, TO_NOTVICT);
                    if (GET_DEATH_TYPE(vict) != DTYPE_HEAD) {
                        GET_DEATH_TYPE(vict) = DTYPE_PULP;
                    }
        ...
        if (!SUNKEN(IN_ROOM(vict)) && SECT(IN_ROOM(vict)) != SECT_WATER_SWIM &&
            ...
            switch (rand_number(1, 5)) {
                case 1:
                    act("@R$N@r explodes and chunks of $M shower to the ground.@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYou explode leaving only chunks behind.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r explodes and chunks of $M shower to the ground.@n", 1, ch, 0, vict, TO_NOTVICT);
                    GET_DEATH_TYPE(vict) = DTYPE_VAPOR;
                    break;
                case 2:
                    act("@rThe bottom half of @R$N@r is all that remains as $E dies.@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rThe bottom half of your body is all that remains as you die.@n", 1, ch, 0, vict, TO_VICT);
                    act("@rThe bottom half of @R$N@r is all that remains as $E dies.@n", 1, ch, 0, vict, TO_NOTVICT);
                    GET_DEATH_TYPE(vict) = DTYPE_HALF;
                    break;
                case 3:
                    act("@R$N@r is completely disintegrated in the attack!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYour body completely disintegrates in the attack!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r is completely disintegrated in the attack!@n", 1, ch, 0, vict, TO_NOTVICT);
                    GET_DEATH_TYPE(vict) = DTYPE_VAPOR;
                    break;
                case 4:
                    act("@R$N@r falls down as a smoldering corpse!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYour body falls down as a smoldering corpse!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r falls down as a smoldering corpse!@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
                case 5:
                    act("@rWhat's left of @R$N@r's body slams into the ground as $E dies!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@rWhat's left of your body slams into the ground as you die!@n", 1, ch, 0, vict, TO_VICT);
                    act("@rWhat's left of @R$N@r's body slams into the ground as $E dies!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    break;
            }
            ...
            switch (rand_number(1, 5)) {
                case 1:
                    act("@R$N@r explodes and chunks of $M shower out into every direction of space.@n", 1, ch, 0,
                        vict, TO_CHAR);
                    act("@rYou explode leaving only chunks behind.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r explodes and chunks of $M shower out into every direction of space.@n", 1, ch, 0,
                        vict, TO_NOTVICT);
                ...
                case 3:
                    ...
                    break;
                case 4:
                    act("@R$N@r floats away as a smoldering corpse!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYour body floats away as a smoldering corpse!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r floats away as a smoldering corpse!@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
                case 5:
                    act("@rWhat's left of @R$N@r's body floats away through space!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rWhat's left of your body floats away through space!@n", 1, ch, 0, vict, TO_VICT);
                    act("@rWhat's left of @R$N@r's body floats away through space!@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
            }
        } else if (SECT(IN_ROOM(vict)) == SECT_FLYING) {
            switch (rand_number(1, 5)) {
                case 1:
                    act("@R$N@r explodes and chunks of $M shower towards the ground far below.@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@rYou explode leaving only chunks behind.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r explodes and chunks of $M shower toward the ground far below.@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    GET_DEATH_TYPE(vict) = DTYPE_VAPOR;
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    act("@R$N@r falls down toward the ground as a smoldering corpse!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYour body falls down toward the ground as a smoldering corpse!@n", 1, ch, 0, vict,
                        TO_VICT);
                    act("@R$N@r falls down toward the ground as a smoldering corpse!@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
                case 5:
                    act("@rWhat's left of @R$N@r's body falls toward the ground as $E dies!@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@rWhat's left of yor body falls toward the ground as you die!@n", 1, ch, 0, vict, TO_VICT);
                    act("@rWhat's left of @R$N@r's body falls toward the ground as $E dies!@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                    break;
            }
            ...
            switch (rand_number(1, 5)) {
                case 1:
                    act("@R$N@r explodes and chunks of $M float freely through the water.@n", 1, ch, 0, vict,
                        TO_CHAR);
                    act("@rYou explode leaving only chunks behind.@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r explodes and chunks of $M float freely through the water.@n", 1, ch, 0, vict,
                        TO_NOTVICT);
                ...
                case 3:
                    ...
                    break;
                case 4:
                    act("@R$N@r falls back as a smoldering corpse!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rYour body falls back as a smoldering corpse!@n", 1, ch, 0, vict, TO_VICT);
                    act("@R$N@r falls back as a smoldering corpse!@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
                case 5:
                    act("@rWhat's left of @R$N@r's body floats limply as $E dies!@n", 1, ch, 0, vict, TO_CHAR);
                    act("@rWhat's left of yor body floats limply as you die!@n", 1, ch, 0, vict, TO_VICT);
                    act("@rWhat's left of @R$N@r's body floats limply as $E dies!@n", 1, ch, 0, vict, TO_NOTVICT);
                    break;
            }
        }
    }
