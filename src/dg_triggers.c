...
void act_mtrigger(const struct char_data *ch, char *str, struct char_data *actor, const struct char_data *victim, struct obj_data *object, const struct obj_data *target, const char *arg)
{
    struct trig_data *t;
  char buf[MAX_INPUT_LENGTH];
