...
/* Prototypes. */
bool start_change_command(struct descriptor_data *d, int pos);
...
ACMD(do_oasis_zedit) {
    ...
    /****************************************************************************/
    if (d->olc) {
        mudlog(BRF, ADMLVL_IMMORT, 1, "SYSERR: do_oasis_zedit: Player already "
                                         "had olc structure.");
        free(d->olc);
    }
    ...
    if (save) {
        ...
        mudlog(CMP, MAX(ADMLVL_BUILDER, GET_INVIS_LEV(ch)), 1,
    ...
    act("$n starts using OLC.", 1, d->character, 0, 0, TO_ROOM);
    SET_BIT_AR(PLR_FLAGS(ch), PLR_WRITING);

    mudlog(CMP, ADMLVL_IMMORT, 1, "OLC: %s starts editing zone %d allowed zone %d",
...
void zedit_new_zone(struct char_data *ch, zone_vnum vzone_num, room_vnum bottom, room_vnum top) {
    ...
    mudlog(BRF, MAX(ADMLVL_BUILDER, GET_INVIS_LEV(ch)), 1, "OLC: %s creates new zone #%d", GET_NAME(ch), vzone_num);
...
void zedit_disp_arg1(struct descriptor_data *d) {
    ...
    switch (OLC_CMD(d).command) {
        ...
        default:
            ...
            mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_disp_arg1(): Help!");
...
void zedit_disp_arg2(struct descriptor_data *d) {
    ...
    switch (OLC_CMD(d).command) {
        ...
        default:
             ...
             */
            cleanup_olc(d, CLEANUP_ALL);
            mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_disp_arg2(): Help!");
            write_to_output(d, "Oops...\r\n");
            return;
    }
...
void zedit_disp_arg3(struct descriptor_data *d) {
    ...
    switch (OLC_CMD(d).command) {
        ...
        default:
             ...
             */
            cleanup_olc(d, CLEANUP_ALL);
            mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_disp_arg3(): Help!");
            write_to_output(d, "Oops...\r\n");
            return;
    }
...
void zedit_disp_arg4(struct descriptor_data *d) {
    ...
    switch (OLC_CMD(d).command) {
        ...
        default:
             ...
             */
            cleanup_olc(d, CLEANUP_ALL);
            mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_disp_arg4(): Help!");
            write_to_output(d, "Oops...\r\n");
            return;
    }
...
void zedit_disp_arg5(struct descriptor_data *d) {
    ...
    switch (OLC_CMD(d).command) {
        ...
        default:
             ...
             */
            cleanup_olc(d, CLEANUP_ALL);
            mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_disp_arg5(): Help!");
            write_to_output(d, "Oops...\r\n");
            return;
    }
        ...
        case ZEDIT_CONFIRM_SAVESTRING:
            switch (*arg) {
                ...
                case 'Y':
                    ...
                    mudlog(CMP, MAX(ADMLVL_BUILDER, GET_INVIS_LEV(d->character)), 1,
        ...
        case ZEDIT_ARG1:
            ...
            switch (OLC_CMD(d).command) {
                ...
                default:
                     ...
                     */
                    cleanup_olc(d, CLEANUP_ALL);
                    mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_parse(): case ARG1: Ack!");
                    write_to_output(d, "Oops...\r\n");
                    break;
            }
            break;
        ...
        case ZEDIT_ARG2:
            ...
            switch (OLC_CMD(d).command) {
                ...
                default:
                     ...
                     */
                    cleanup_olc(d, CLEANUP_ALL);
                    mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_parse(): case ARG2: Ack!");
                    write_to_output(d, "Oops...\r\n");
                    break;
            }
            break;
        ...
        case ZEDIT_ARG3:
            ...
            switch (OLC_CMD(d).command) {
                ...
                default:
                     ...
                     */
                    cleanup_olc(d, CLEANUP_ALL);
                    mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_parse(): case ARG3: Ack!");
                    write_to_output(d, "Oops...\r\n");
                    break;
            }
            break;
        ...
        case ZEDIT_ARG4:
            ...
            switch (OLC_CMD(d).command) {
                ...
                default:
                     ...
                     */
                    cleanup_olc(d, CLEANUP_ALL);
                    mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_parse(): case ARG4: Ack!");
                    write_to_output(d, "Oops...\r\n");
                    break;
            }
            break;
        ...
        case ZEDIT_ARG5:
            ...
            switch (OLC_CMD(d).command) {
                ...
                default:
                     ...
                     */
                    cleanup_olc(d, CLEANUP_ALL);
                    mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_parse(): case ARG5: Ack!");
                    write_to_output(d, "Oops...\r\n");
                    break;
            }
            break;
...
/*-------------------------------------------------------------------*/
        ...
        default:
             ...
             */
            cleanup_olc(d, CLEANUP_ALL);
            mudlog(BRF, ADMLVL_BUILDER, 1, "SYSERR: OLC: zedit_parse(): Reached default case!");
            write_to_output(d, "Oops...\r\n");
            break;
    }
}
